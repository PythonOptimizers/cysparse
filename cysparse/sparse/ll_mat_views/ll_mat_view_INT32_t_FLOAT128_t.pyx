"""
Lightweight object to view a :class:`LLSparseMatrix_INT32_t_FLOAT128_t`.
...
cdef class LLSparseMatrixView_INT32_t_FLOAT128_t:
    ...
    def __cinit__(self,control_object, LLSparseMatrix_INT32_t_FLOAT128_t A, INT32_t nrow, INT32_t ncol):
        ...
        self.__full_type_str = "LLSparseMatrixView [INT32_t, FLOAT128_t]"
    ...
    def __getitem__(self, tuple key):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[1]):
            return MakeLLSparseMatrixViewFromView_INT32_t_FLOAT128_t(self, <PyObject *>key[0], <PyObject *>key[1])
    ...
    def __setitem__(self, tuple key, value):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[0]):
            ...
            view = MakeLLSparseMatrixViewFromView_INT32_t_FLOAT128_t(self, <PyObject *>key[0], <PyObject *>key[1])
    ...
    def matrix_copy(self, compress=True):
        """
        Create a new :class:`LLSparseMatrix_INT32_t_FLOAT128_t` from the view and return it.
    ...
    def copy(self):
        """
        Create a new :class:`LLSparseMatrixView_INT32_t_FLOAT128_t` from this object.
...
# Factory methods
########################################################################################################################
cdef LLSparseMatrixView_INT32_t_FLOAT128_t MakeLLSparseMatrixView_INT32_t_FLOAT128_t(LLSparseMatrix_INT32_t_FLOAT128_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT32_t_FLOAT128_t` for a :class:`LLSparseMatrix_INT32_t_FLOAT128_t`.
    ...
    Returns:
        A corresponding :class:`LLSparseMatrixView_INT32_t_FLOAT128_t`. This view can be empty with the wrong index objects.

    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrix_INT32_t_FLOAT128_t`.
    ...
    cdef LLSparseMatrixView_INT32_t_FLOAT128_t view = LLSparseMatrixView_INT32_t_FLOAT128_t(unexposed_value, A, nrow, ncol)
...
cdef LLSparseMatrixView_INT32_t_FLOAT128_t MakeLLSparseMatrixViewFromView_INT32_t_FLOAT128_t(LLSparseMatrixView_INT32_t_FLOAT128_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT32_t_FLOAT128_t` for a :class:`LLSparseMatrixView_INT32_t_FLOAT128_t`.
    ...
    Args:
        A: A :class:`LLSparseMatrixView_INT32_t_FLOAT128_t` to be *viewed*.
        obj1: First index object.
        obj2: Second index object.
    ...
    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrixView_INT32_t_FLOAT128_t`.
    ...
    cdef LLSparseMatrixView_INT32_t_FLOAT128_t view = LLSparseMatrixView_INT32_t_FLOAT128_t(unexposed_value, A.A, nrow, ncol)
