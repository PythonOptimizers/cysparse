...
#######################################################################
class CySparseDiagNoSymmetryNoZero_CSCSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
#######################################################################
class CySparseDiagWithSymmetryNoZero_CSCSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
#######################################################################
class CySparseDiagNoSymmetrySWithZero_CSCSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
#######################################################################
class CySparseDiagWithSymmetrySWithZero_CSCSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
