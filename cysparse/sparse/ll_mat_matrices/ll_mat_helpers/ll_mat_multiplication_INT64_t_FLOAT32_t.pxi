...
cdef LLSparseMatrix_INT64_t_FLOAT32_t multiply_transposed_ll_mat_with_self(LLSparseMatrix_INT64_t_FLOAT32_t A):
    ...
    C = LLSparseMatrix_INT64_t_FLOAT32_t(control_object=unexposed_value, nrow=A.ncol, ncol=A.ncol, size_hint=size_hint, store_zeros=store_zeros, use_symmetric_storage=True)
