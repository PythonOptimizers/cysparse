...
class CySparseCommonAttributesMatricesViews_ConjugatedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricMatricesViews_ConjugatedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesWithZeroMatricesViews_ConjugatedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricWithZeroMatricesViews_ConjugatedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
