...
###########################################
cdef void multiply_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, COMPLEX256_t *x, COMPLEX256_t *y,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
# C-contiguous, non symmetric with memorieviews
###########################################
cdef void multiply_ll_mat_with_numpy_vector_kernel2_INT64_t_COMPLEX256_t(INT64_t m, COMPLEX256_t [::1] x, COMPLEX256_t [::1] y,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, COMPLEX256_t *x, COMPLEX256_t *y,
             COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m,
...
###########################################
cdef void multiply_sym_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m,
                COMPLEX256_t *x, INT64_t incx,
                COMPLEX256_t *y, INT64_t incy,
                COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, INT64_t n, COMPLEX256_t *x, COMPLEX256_t *y,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, INT64_t n, COMPLEX256_t *x, INT64_t incx, COMPLEX256_t *y, INT64_t incy,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute :math:`y = A^t * x`.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_tranposed_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, INT64_t n, COMPLEX256_t *x, COMPLEX256_t *y,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_tranposed_sym_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, INT64_t n, COMPLEX256_t *x, COMPLEX256_t *y,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute :math:`y = A^h * x`.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_tranposed_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, INT64_t n, COMPLEX256_t *x, INT64_t incx, COMPLEX256_t *y, INT64_t incy,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute :math:`y = A^h * x`.
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_tranposed_sym_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, INT64_t n, COMPLEX256_t *x, INT64_t incx, COMPLEX256_t *y, INT64_t incy,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute :math:`y = A^h * x`.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, COMPLEX256_t *x, COMPLEX256_t *y,
         COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = conj(A) * x``.
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_sym_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m, COMPLEX256_t *x, COMPLEX256_t *y,
             COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = conj(A) * x``.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m,
            COMPLEX256_t *x, INT64_t incx,
            COMPLEX256_t *y, INT64_t incy,
            COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_sym_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX256_t(INT64_t m,
                COMPLEX256_t *x, INT64_t incx,
                COMPLEX256_t *y, INT64_t incy,
                COMPLEX256_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
