...
cdef LLSparseMatrix_INT32_t_COMPLEX64_t MakeBandLLSparseMatrix_INT32_t_COMPLEX64_t(LLSparseMatrix_INT32_t_COMPLEX64_t A, diag_coeff, list numpy_arrays):
    """
    Populate an ``LLSparseMatrix_INT32_t_COMPLEX64_t with diagonals.
