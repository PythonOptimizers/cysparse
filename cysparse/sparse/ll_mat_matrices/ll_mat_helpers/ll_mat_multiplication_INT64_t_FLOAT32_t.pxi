...
# A * b
######################
cdef cnp.ndarray[cnp.float32_t, ndim=1, mode='c'] multiply_ll_mat_with_numpy_vector_INT64_t_FLOAT32_t(LLSparseMatrix_INT64_t_FLOAT32_t A, cnp.ndarray[cnp.float32_t, ndim=1] b):
    """
...
# A^t * b
######################
cdef cnp.ndarray[cnp.float32_t, ndim=1, mode='c'] multiply_transposed_ll_mat_with_numpy_vector_INT64_t_FLOAT32_t(LLSparseMatrix_INT64_t_FLOAT32_t A, cnp.ndarray[cnp.float32_t, ndim=1] b):
    """
