...
cdef class CSCSparseMatrix_INT64_t_FLOAT64_t(ImmutableSparseMatrix_INT64_t_FLOAT64_t):
    ...
    def copy(self):
        ...
        self_copy = CSCSparseMatrix_INT64_t_FLOAT64_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zeros=self.__store_zeros, is_symmetric=self.__is_symmetric)
    ...
    def tril(self, int k):
        ...
        return MakeCSCSparseMatrix_INT64_t_FLOAT64_t(self.__nrow, self.__ncol, nnz, ind, row, val, is_symmetric=False, store_zeros=self.__store_zeros)
    ...
    def to_csr(self):
        ...
        return MakeCSRSparseMatrix_INT64_t_FLOAT64_t(self.__nrow, self.__ncol, self.__nnz, ind, col, val, is_symmetric=self.is_symmetric, store_zeros=self.store_zeros)
