...
#######################################################################
class CySparseFindNoSymmetryNoZero_LLSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = NROW
        self.ncol = NCOL
...
#######################################################################
class CySparseFindWithSymmetryNoZero_LLSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = SIZE
...
#######################################################################
class CySparseFindNoSymmetrySWithZero_LLSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = NROW
        self.ncol = NCOL
...
#######################################################################
class CySparseFindWithSymmetrySWithZero_LLSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = SIZE
