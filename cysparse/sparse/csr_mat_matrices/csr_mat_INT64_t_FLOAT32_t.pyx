...
cdef MakeCSRSparseMatrix_INT64_t_FLOAT32_t(INT64_t nrow,
    ...
    csr_mat = CSRSparseMatrix_INT64_t_FLOAT32_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, store_symmetric=store_symmetric, store_zero=store_zero)
