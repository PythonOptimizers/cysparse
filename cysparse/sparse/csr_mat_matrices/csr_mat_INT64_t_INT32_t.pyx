...
from cysparse.sparse.sparse_utils.generic.matrix_translations_INT64_t_INT32_t cimport csr_to_csc_kernel_INT64_t_INT32_t, csc_to_csr_kernel_INT64_t_INT32_t, csr_to_ll_kernel_INT64_t_INT32_t
...
include "csr_mat_helpers/csr_mat_is_symmetric_INT64_t_INT32_t.pxi"
...
cdef class CSRSparseMatrix_INT64_t_INT32_t(ImmutableSparseMatrix_INT64_t_INT32_t):
    ...
    def copy(self):
        ...
        self_copy = CSRSparseMatrix_INT64_t_INT32_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def to_ll(self):
        ...
        csr_to_ll_kernel_INT64_t_INT32_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT64_t *>self.ind, <INT64_t *>self.col, <INT32_t *>self.val,
                       root, col, link, val)
...
cdef MakeCSRSparseMatrix_INT64_t_INT32_t(INT64_t nrow,
    ...
    csr_mat = CSRSparseMatrix_INT64_t_INT32_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, store_symmetric=store_symmetric, store_zero=store_zero)
