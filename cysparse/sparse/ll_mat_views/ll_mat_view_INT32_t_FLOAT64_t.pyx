"""
Lightweight object to view a :class:`LLSparseMatrix_INT32_t_FLOAT64_t`.
...
cdef class LLSparseMatrixView_INT32_t_FLOAT64_t:
    ...
    # Init/Free/Memory
    ####################################################################################################################
    def __cinit__(self,control_object, LLSparseMatrix_INT32_t_FLOAT64_t A, INT32_t nrow, INT32_t ncol):
        ...
        self.__full_type_str = "LLSparseMatrixView [INT32_t, FLOAT64_t]"
    ...
    def __getitem__(self, tuple key):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[1]):
            return MakeLLSparseMatrixViewFromView_INT32_t_FLOAT64_t(self, <PyObject *>key[0], <PyObject *>key[1])
    ...
    def __setitem__(self, tuple key, value):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[0]):
            ...
            view = MakeLLSparseMatrixViewFromView_INT32_t_FLOAT64_t(self, <PyObject *>key[0], <PyObject *>key[1])
    ...
    def matrix_copy(self, compress=True):
        """
        Create a new :class:`LLSparseMatrix_INT32_t_FLOAT64_t` from the view and return it.

        Args:
            compress: If ``True``, we use the minimum size for the matrix.

        Note:
            Because we lost sight of zero elements added in the viewed :class:`LLSparseMatrix_INT32_t_FLOAT64_t`,
        ...
        cdef LLSparseMatrix_INT32_t_FLOAT64_t A_copy = LLSparseMatrix_INT32_t_FLOAT64_t(control_object=unexposed_value,
                                                                                  nrow=self.__nrow,
                                                                                  ncol=self.__ncol,
                                                                                  size_hint=size_hint,
                                                                                  store_zero=False,
    ...
    def copy(self):
        """
        Create a new :class:`LLSparseMatrixView_INT32_t_FLOAT64_t` from this object.
        ...
        cdef LLSparseMatrixView_INT32_t_FLOAT64_t view = LLSparseMatrixView_INT32_t_FLOAT64_t(unexposed_value, self.A, self.__nrow, self.__ncol)
...
cdef LLSparseMatrixView_INT32_t_FLOAT64_t MakeLLSparseMatrixView_INT32_t_FLOAT64_t(LLSparseMatrix_INT32_t_FLOAT64_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT32_t_FLOAT64_t` for a :class:`LLSparseMatrix_INT32_t_FLOAT64_t`.
    ...
    Returns:
        A corresponding :class:`LLSparseMatrixView_INT32_t_FLOAT64_t`. This view can be empty with the wrong index objects.

    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrix_INT32_t_FLOAT64_t`.
    ...
    cdef LLSparseMatrixView_INT32_t_FLOAT64_t view = LLSparseMatrixView_INT32_t_FLOAT64_t(unexposed_value, A, nrow, ncol)
...
cdef LLSparseMatrixView_INT32_t_FLOAT64_t MakeLLSparseMatrixViewFromView_INT32_t_FLOAT64_t(LLSparseMatrixView_INT32_t_FLOAT64_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT32_t_FLOAT64_t` for a :class:`LLSparseMatrixView_INT32_t_FLOAT64_t`.
    ...
    Args:
        A: A :class:`LLSparseMatrixView_INT32_t_FLOAT64_t` to be *viewed*.
        obj1: First index object.
        obj2: Second index object.
    ...
    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrixView_INT32_t_FLOAT64_t`.
    ...
    cdef LLSparseMatrixView_INT32_t_FLOAT64_t view = LLSparseMatrixView_INT32_t_FLOAT64_t(unexposed_value, A.A, nrow, ncol)
