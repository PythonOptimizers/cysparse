...
cdef LLSparseMatrix_INT32_t_COMPLEX128_t MakePermutationLLSparseMatrix_INT32_t_COMPLEX128_t(LLSparseMatrix_INT32_t_COMPLEX128_t A, cnp.ndarray numpy_vector):
    """
    Populate an ``LLSparseMatrix_INT32_t_COMPLEX128_t as a permutation matrix given a vector of permutation.
