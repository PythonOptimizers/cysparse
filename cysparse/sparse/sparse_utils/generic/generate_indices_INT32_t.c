...
/* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":68
 * 
 * 
 ...
 *         length = 1
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":119
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":126
 *     elif PySlice_Check(obj):
 *         # slice
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)             # <<<<<<<<<<<<<<
 *         if ret:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":127
 *         # slice
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)
 *         if ret:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Slice could not be translated")
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":132
 *         #print "start, stop, step, length = (%d, %d, %d, %d)" % (start, stop, step, length)
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))             # <<<<<<<<<<<<<<
 *         if not indices:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":138
 *         # populate indices
 *         i = start
 *         for j from 0 <= j < length:             # <<<<<<<<<<<<<<
 *             indices[j] = i
 ...
 */
          ...
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_5);
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":169
 *         length = <Py_ssize_t> PyArray_DIM(<PyArrayObject *>obj, 0)
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))             # <<<<<<<<<<<<<<
 *         if not indices:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":170
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:             # <<<<<<<<<<<<<<
 *             raise MemoryError()
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":175
 *         # TODO: remove or control this is not DANGEROUS
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":196
 *     number_of_elements[0] = <INT32_t> length
 * 
 *     return indices             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":27
 * 
