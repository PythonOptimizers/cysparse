...
###########################################
cdef void multiply_csr_mat_with_numpy_vector_kernel_INT32_t_INT32_t(INT32_t m, INT32_t *x, INT32_t *y,
         INT32_t *val, INT32_t *col, INT32_t *ind):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csr_mat_with_numpy_vector_kernel_INT32_t_INT32_t(INT32_t m, INT32_t *x, INT32_t *y,
             INT32_t *val, INT32_t *col, INT32_t *ind):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_csr_mat_with_strided_numpy_vector_kernel_INT32_t_INT32_t(INT32_t m,
...
###########################################
cdef void multiply_sym_csr_mat_with_strided_numpy_vector_kernel_INT32_t_INT32_t(INT32_t m,
                INT32_t *x, INT32_t incx,
                INT32_t *y, INT32_t incy,
                INT32_t *val, INT32_t *col, INT32_t *ind):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csr_mat_with_numpy_vector_kernel_INT32_t_INT32_t(INT32_t m, INT32_t n, INT32_t *x, INT32_t *y,
         INT32_t *val, INT32_t *col, INT32_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csr_mat_with_strided_numpy_vector_kernel_INT32_t_INT32_t(INT32_t m, INT32_t n, INT32_t *x, INT32_t incx, INT32_t *y, INT32_t incy,
         INT32_t *val, INT32_t *col, INT32_t *ind):
    """
    Compute :math:`y = A^t * x`.
