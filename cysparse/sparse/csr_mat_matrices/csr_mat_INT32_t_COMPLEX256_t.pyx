...
include "csr_mat_helpers/csr_mat_is_symmetric_INT32_t_COMPLEX256_t.pxi"
...
cdef class CSRSparseMatrix_INT32_t_COMPLEX256_t(ImmutableSparseMatrix_INT32_t_COMPLEX256_t):
    ...
    def copy(self):
        ...
        self_copy = CSRSparseMatrix_INT32_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def tril(self, int k = 0):
        ...
        return MakeCSRSparseMatrix_INT32_t_COMPLEX256_t(self.__nrow,
                                                  self.__ncol,
                                                  nnz,
                                                  ind,
                                                  col,
    ...
    def to_csc(self):
        ...
        return MakeCSCSparseMatrix_INT32_t_COMPLEX256_t(self.__nrow,
                                                  self.__ncol,
                                                  self.__nnz,
                                                  ind,
                                                  row,
...
cdef MakeCSRSparseMatrix_INT32_t_COMPLEX256_t(INT32_t nrow,
    ...
    csr_mat = CSRSparseMatrix_INT32_t_COMPLEX256_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, store_symmetric=store_symmetric, store_zero=store_zero)
