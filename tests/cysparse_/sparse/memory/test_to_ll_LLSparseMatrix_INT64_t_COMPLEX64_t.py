...
#######################################################################
class CySparseToLLNoSymmetryNoZero_LLSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
#######################################################################
class CySparseToLLWithSymmetryNoZero_LLSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
#######################################################################
class CySparseToLLNoSymmetrySWithZero_LLSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
#######################################################################
class CySparseToLLWithSymmetrySWithZero_LLSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
