...
#######################################################################
class CySparsecombilisNoSymmetryNoZero_ConjugatedSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisWithSymmetryNoZero_ConjugatedSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisNoSymmetrySWithZero_ConjugatedSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisWithSymmetrySWithZero_ConjugatedSparseMatrix_INT64_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
