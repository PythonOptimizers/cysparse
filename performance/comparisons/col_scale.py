...
class LLMatColScaleBenchmark_1(LLMatColScaleBenchmark):


    label = "Simple col_scale with 1000 elements and size = 10,000"
    each = 10
...
class LLMatColScaleBenchmark_2(LLMatColScaleBenchmark):


    label = "Simple col_scale with 10000 elements and size = 100,000"
    each = 10
...
class LLMatColScaleBenchmark_3(LLMatColScaleBenchmark):


    label = "Simple col_scale with 80,000 elements and size = 100,000"
    each = 10
