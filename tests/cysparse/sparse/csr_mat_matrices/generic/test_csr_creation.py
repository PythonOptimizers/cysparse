...
class CySparseCSRCreationFromLLSparseMatrixTestCase(CySparseCSRCreationBaseTestCase):
    ...
    def test_symmetric_attribute(self):
        ...
        self.failUnless(self.l_1_1.is_symmetric == self.l_1_1_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_2.is_symmetric == self.l_1_2_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_3.is_symmetric == self.l_1_3_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_4.is_symmetric == self.l_1_4_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_5.is_symmetric == self.l_1_5_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_6.is_symmetric == self.l_1_6_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_7.is_symmetric == self.l_1_7_csr.is_symmetric == False)
  
        self.failUnless(self.l_1_8.is_symmetric == self.l_1_8_csr.is_symmetric == False)
  

  
  
        self.failUnless(self.l_2_1.is_symmetric == self.l_2_1_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_2.is_symmetric == self.l_2_2_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_3.is_symmetric == self.l_2_3_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_4.is_symmetric == self.l_2_4_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_5.is_symmetric == self.l_2_5_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_6.is_symmetric == self.l_2_6_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_7.is_symmetric == self.l_2_7_csr.is_symmetric == False)
  
        self.failUnless(self.l_2_8.is_symmetric == self.l_2_8_csr.is_symmetric == False)
...
class CySparseCSRCreationFromSymmetricLLSparseMatrixTestCase(CySparseCSRCreationBaseTestCase):
    ...
    def test_symmetric_attribute(self):
        ...
        self.failUnless(self.l_1_1.is_symmetric == self.l_1_1_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_2.is_symmetric == self.l_1_2_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_3.is_symmetric == self.l_1_3_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_4.is_symmetric == self.l_1_4_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_5.is_symmetric == self.l_1_5_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_6.is_symmetric == self.l_1_6_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_7.is_symmetric == self.l_1_7_csr.is_symmetric == True)
  
        self.failUnless(self.l_1_8.is_symmetric == self.l_1_8_csr.is_symmetric == True)
  

  
  
        self.failUnless(self.l_2_1.is_symmetric == self.l_2_1_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_2.is_symmetric == self.l_2_2_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_3.is_symmetric == self.l_2_3_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_4.is_symmetric == self.l_2_4_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_5.is_symmetric == self.l_2_5_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_6.is_symmetric == self.l_2_6_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_7.is_symmetric == self.l_2_7_csr.is_symmetric == True)
  
        self.failUnless(self.l_2_8.is_symmetric == self.l_2_8_csr.is_symmetric == True)
