...
class CySparseCommonAttributesMatricesProxies_LLSparseMatrixView_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricMatricesProxies_LLSparseMatrixView_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesWithZeroMatricesProxies_LLSparseMatrixView_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricWithZeroMatricesProxies_LLSparseMatrixView_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
