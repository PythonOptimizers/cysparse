...
class CySparseCommonAttributesMatricesViews_ConjugateTransposedSparseMatrix_INT32_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricMatricesViews_ConjugateTransposedSparseMatrix_INT32_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesWithZeroMatricesViews_ConjugateTransposedSparseMatrix_INT32_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricWithZeroMatricesViews_ConjugateTransposedSparseMatrix_INT32_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
