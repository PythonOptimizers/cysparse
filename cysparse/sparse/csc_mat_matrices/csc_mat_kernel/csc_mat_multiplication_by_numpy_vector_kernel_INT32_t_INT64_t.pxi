...
###########################################
cdef void multiply_csc_mat_with_numpy_vector_kernel_INT32_t_INT64_t(INT32_t m, INT32_t n, INT64_t *x, INT64_t *y,
         INT64_t *val, INT32_t *row, INT32_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_numpy_vector_kernel_INT32_t_INT64_t(INT32_t m, INT32_t n, INT64_t *x, INT64_t *y,
             INT64_t *val, INT32_t *row, INT32_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_csc_mat_with_strided_numpy_vector_kernel_INT32_t_INT64_t(INT32_t m, INT32_t n,
            INT64_t *x, INT32_t incx,
            INT64_t *y, INT32_t incy,
            INT64_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_strided_numpy_vector_kernel_INT32_t_INT64_t(INT32_t m, INT32_t n,
                INT64_t *x, INT32_t incx,
                INT64_t *y, INT32_t incy,
                INT64_t *val, INT32_t *row, INT32_t *ind):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_numpy_vector_kernel_INT32_t_INT64_t(INT32_t m, INT32_t n, INT64_t *x, INT64_t *y,
         INT64_t *val, INT32_t *row, INT32_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT32_t_INT64_t(INT32_t m, INT32_t n, INT64_t *x, INT32_t incx, INT64_t *y, INT32_t incy,
         INT64_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute :math:`y = A^t * x`.
