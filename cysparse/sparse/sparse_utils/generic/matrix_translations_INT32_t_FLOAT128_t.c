...
/* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":7
 * 
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":38
 *     # cumsum the nnz per column to get csc_ind
 *     cdef:
 *         INT32_t cumsum = 0             # <<<<<<<<<<<<<<
 *         INT32_t temp = 0
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":56
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":69
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j <= __pyx_t_1; __pyx_v_j++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":72
 * 
 *     for j from 0 <= j <= ncol:
 *         temp   = csc_ind[j]             # <<<<<<<<<<<<<<
 *         csc_ind[j] = last
...
/* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":78
 * 
 * 
 ...
 */
  ...
  for (__pyx_v_n = 0; __pyx_v_n < __pyx_t_1; __pyx_v_n++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":105
 *     # count nnz per row
 *     for n from 0 <= n < nnz:
 *         csr_ind[csc_row[n]] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":109
 *     # cumsum the nnz per row to get csr_ind
 *     cdef:
 *         INT32_t cumsum = 0             # <<<<<<<<<<<<<<
 *         INT32_t temp = 0
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":110
 *     cdef:
 *         INT32_t cumsum = 0
 *         INT32_t temp = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":113
 * 
 *     for i from 0<= i < nrow:
 *         temp  = csr_ind[i]             # <<<<<<<<<<<<<<
 *         csr_ind[i] = cumsum
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":127
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_1; __pyx_v_j++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":128
 * 
 *     for j from 0 <= j < ncol:
 *         for ii from csc_ind[j] <= ii < csc_ind[j+1]:             # <<<<<<<<<<<<<<
 *             i  = csc_row[ii]
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":140
 *     # from [1, 2, 3, 3] get back [0, 1, 2 , 3]
 * 
 *     cdef INT32_t last = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i <= __pyx_t_1; __pyx_v_i++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":143
 * 
 *     for i from 0 <= i <= nrow:
 *         temp   = csr_ind[i]             # <<<<<<<<<<<<<<
 *         csr_ind[i] = last
