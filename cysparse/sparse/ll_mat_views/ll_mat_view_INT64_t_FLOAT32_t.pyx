...
"""
Lightweight object to view a :class:`LLSparseMatrix_INT64_t_FLOAT32_t`.
...
cdef class LLSparseMatrixView_INT64_t_FLOAT32_t:
    ...
    # Init/Free/Memory
    ####################################################################################################################
    def __cinit__(self,control_object, LLSparseMatrix_INT64_t_FLOAT32_t A, INT64_t nrow, INT64_t ncol):
        ...
        self.__full_type_str = "LLSparseMatrixView [INT64_t, FLOAT32_t]"
    ...
    def __getitem__(self, tuple key):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[1]):
            return MakeLLSparseMatrixViewFromView_INT64_t_FLOAT32_t(self, <PyObject *>key[0], <PyObject *>key[1])
    ...
    def copy(self):
        """
        Create a new :class:`LLSparseMatrixView_INT64_t_FLOAT32_t` from this object.
        ...
        cdef LLSparseMatrixView_INT64_t_FLOAT32_t view = LLSparseMatrixView_INT64_t_FLOAT32_t(unexposed_value, self.A, self.__nrow, self.__ncol)
...
cdef LLSparseMatrixView_INT64_t_FLOAT32_t MakeLLSparseMatrixView_INT64_t_FLOAT32_t(LLSparseMatrix_INT64_t_FLOAT32_t A, PyObject* obj1, PyObject* obj2):
    ...
    Returns:
        A corresponding :class:`LLSparseMatrixView_INT64_t_FLOAT32_t`. This view can be empty with the wrong index objects.

    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrix_INT64_t_FLOAT32_t`.
    ...
    cdef LLSparseMatrixView_INT64_t_FLOAT32_t view = LLSparseMatrixView_INT64_t_FLOAT32_t(unexposed_value, A, nrow, ncol)
...
cdef LLSparseMatrixView_INT64_t_FLOAT32_t MakeLLSparseMatrixViewFromView_INT64_t_FLOAT32_t(LLSparseMatrixView_INT64_t_FLOAT32_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT64_t_FLOAT32_t` for a :class:`LLSparseMatrixView_INT64_t_FLOAT32_t`.
    ...
    Args:
        A: A :class:`LLSparseMatrixView_INT64_t_FLOAT32_t` to be *viewed*.
        obj1: First index object.
        obj2: Second index object.
    ...
    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrixView_INT64_t_FLOAT32_t`.
    ...
    cdef LLSparseMatrixView_INT64_t_FLOAT32_t view = LLSparseMatrixView_INT64_t_FLOAT32_t(unexposed_value, A.A, nrow, ncol)
