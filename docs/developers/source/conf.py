...
try:
    from cysparse import __version__
    # The short X.Y version.
...
latex_documents = [
  ('contents', 'cysparse_developers_manual.tex', ur"CySparse's developers manual",
   ur'Nikolaj van Omme\\Sylvain Arreckx\\Dominique Orban', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'logo/cysparse_logo128.pdf'
