...
cdef void multiply_csc_mat_with_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n, COMPLEX64_t *x, COMPLEX64_t *y,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_transposed_csc_mat_with_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n, COMPLEX64_t *x, COMPLEX64_t *y,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_transposed_sym_csc_mat_with_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n, COMPLEX64_t *x, COMPLEX64_t *y,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute :math:`y = A^h * x`.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n, COMPLEX64_t *x, INT64_t incx, COMPLEX64_t *y, INT64_t incy,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute :math:`y = A^h * x`.
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_transposed_sym_csc_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n,
    COMPLEX64_t *x, INT64_t incx,COMPLEX64_t *y, INT64_t incy,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute :math:`y = A^h * x`.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugated_csc_mat_with_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n, COMPLEX64_t *x, COMPLEX64_t *y,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute ``y = conj(A) * x``.
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugated_sym_csc_mat_with_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n, COMPLEX64_t *x, COMPLEX64_t *y,
             COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute ``y = conj(A) * x``.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugated_csc_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n,
         COMPLEX64_t *x, INT64_t incx,
         COMPLEX64_t *y, INT64_t incy,
         COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugated_sym_csc_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX64_t(INT64_t m, INT64_t n,
            COMPLEX64_t *x, INT64_t incx, COMPLEX64_t *y, INT64_t incy,
            COMPLEX64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute ``y = conj(A) * x``.
