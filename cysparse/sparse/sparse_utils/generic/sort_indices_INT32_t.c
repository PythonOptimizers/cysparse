...
#define __PYX_HAVE__cysparse__sparse__sparse_utils__generic__sort_indices_INT32_t
#define __PYX_HAVE_API__cysparse__sparse__sparse_utils__generic__sort_indices_INT32_t
#include "string.h"
#include "stdio.h"
#include "pythread.h"
#include "limits.h"
...
#define __Pyx_MODULE_NAME "cysparse.sparse.sparse_utils.generic.sort_indices_INT32_t"
int __pyx_module_is_main_cysparse__sparse__sparse_utils__generic__sort_indices_INT32_t = 0;

/* Implementation of 'cysparse.sparse.sparse_utils.generic.sort_indices_INT32_t' */
...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_20sort_indices_INT32_t_sort_array_INT32_t(__pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t *__pyx_v_a, __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_start, __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_end) {
  ...
  __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_value;
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_cysparse__sparse__sparse_utils__generic__sort_indices_INT32_t) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "cysparse.sparse.sparse_utils.generic.sort_indices_INT32_t")) {
      if (unlikely(PyDict_SetItemString(modules, "cysparse.sparse.sparse_utils.generic.sort_indices_INT32_t", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cysparse.sparse.sparse_utils.generic.sort_indices_INT32_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cysparse.sparse.sparse_utils.generic.sort_indices_INT32_t");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
