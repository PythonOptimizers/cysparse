...
# A^t * b
######################
cdef cnp.ndarray[cnp.complex64_t, ndim=1, mode='c'] multiply_transposed_ll_mat_with_numpy_vector_INT64_t_COMPLEX64_t(LLSparseMatrix_INT64_t_COMPLEX64_t A, cnp.ndarray[cnp.complex64_t, ndim=1] b):
    """
