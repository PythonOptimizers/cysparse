...
cdef class CSRSparseMatrix_INT64_t_FLOAT128_t(ImmutableSparseMatrix_INT64_t_FLOAT128_t):
    ...
    def tril(self, int k):
        ...
        return MakeCSRSparseMatrix_INT64_t_FLOAT128_t(self.__nrow, self.__ncol, nnz, ind, col, val, is_symmetric=False, store_zeros=self.__store_zeros)
    ...
    def to_csc(self):
        ...
        return MakeCSCSparseMatrix_INT64_t_FLOAT128_t(self.__nrow, self.__ncol, self.__nnz, ind, row, val, is_symmetric=self.is_symmetric, store_zeros=self.store_zeros)
