...
cdef class SparseMatrix_INT64_t_COMPLEX64_t(SparseMatrix):
    cdef:
        ...
        ConjugateTransposedSparseMatrix_INT64_t_COMPLEX64_t __conjugate_transposed_proxy_matrix
        bint __conjugate_transposed_proxy_matrix_generated

        # proxy to the conjugated matrix
        ConjugatedSparseMatrix_INT64_t_COMPLEX64_t __conjugated_proxy_matrix
