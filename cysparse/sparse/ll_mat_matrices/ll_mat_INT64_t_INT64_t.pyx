...
cdef class LLSparseMatrix_INT64_t_INT64_t(MutableSparseMatrix_INT64_t_INT64_t):
    ...
    def create_transpose(self):
        ...
        if self.is_symmetric:
            ...
            transposed = LLSparseMatrix_INT64_t_INT64_t(control_object=unexposed_value, nrow=self.ncol, ncol=self.nrow, size_hint=self.nnz, store_zeros=self.store_zeros, is_symmetric=self.is_symmetric)
