...
cdef LLSparseMatrix_INT64_t_FLOAT64_t MakePermutationLLSparseMatrix_INT64_t_FLOAT64_t(LLSparseMatrix_INT64_t_FLOAT64_t A, cnp.ndarray numpy_vector):
    """
    Populate an ``LLSparseMatrix_INT64_t_FLOAT64_t as a permutation matrix given a vector of permutation.

    See https://en.wikipedia.org/wiki/Permutation_matrix.

    Args:
        A: A ``LLSparseMatrix_INT64_t_FLOAT64_t`` matrix.
