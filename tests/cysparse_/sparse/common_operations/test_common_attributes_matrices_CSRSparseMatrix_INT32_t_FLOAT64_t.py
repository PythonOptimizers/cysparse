...
class CySparseCommonAttributesSymmetricMatrices_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=FLOAT64_T, itype=INT32_T, store_symmetric=True)
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=FLOAT64_T, itype=INT32_T, store_symmetric=True, store_zero=True)
