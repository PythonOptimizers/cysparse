...
cdef LLSparseMatrix_INT64_t_COMPLEX128_t MakeBandLLSparseMatrix_INT64_t_COMPLEX128_t(LLSparseMatrix_INT64_t_COMPLEX128_t A, diag_coeff, list numpy_arrays):
    """
    Populate an ``LLSparseMatrix_INT64_t_COMPLEX128_t with diagonals.
