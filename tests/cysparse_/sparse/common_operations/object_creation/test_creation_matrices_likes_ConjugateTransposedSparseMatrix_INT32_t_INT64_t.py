...
##################################
class CySparseCreationMatrices_ConjugateTransposedSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
##################################
class CySparseCreationSymmetricMatrices_ConjugateTransposedSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 14
...
##################################
class CySparseCreationWithZeroMatrices_ConjugateTransposedSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Zero
##################################
class CySparseCreationSymmetricWithZeroMatrices_ConjugateTransposedSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 14
