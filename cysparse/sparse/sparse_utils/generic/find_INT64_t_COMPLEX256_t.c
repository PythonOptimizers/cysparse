...
/* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":15
 * 
 * 
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_25find_INT64_t_COMPLEX256_t_compare_complex_COMPLEX256_t(__pyx_t_long_double_complex __pyx_v_a, __pyx_t_long_double_complex __pyx_v_b) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":22
 *     """
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":23
 * 
 *     if creall(a) > creall(b):
 *         return 1             # <<<<<<<<<<<<<<
 *     elif creall(a) < creall(b):
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":24
 *     if creall(a) > creall(b):
 *         return 1
 *     elif creall(a) < creall(b):             # <<<<<<<<<<<<<<
 *         return -1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":25
 *         return 1
 *     elif creall(a) < creall(b):
 *         return -1             # <<<<<<<<<<<<<<
 *     elif cimagl(a) > cimagl(b):
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":26
 *     elif creall(a) < creall(b):
 *         return -1
 *     elif cimagl(a) > cimagl(b):             # <<<<<<<<<<<<<<
 *         # real parts are equal
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":28
 *     elif cimagl(a) > cimagl(b):
 *         # real parts are equal
 *         return 1             # <<<<<<<<<<<<<<
 *     elif cimagl(a) < cimagl(b):
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":29
 *         # real parts are equal
 *         return 1
 *     elif cimagl(a) < cimagl(b):             # <<<<<<<<<<<<<<
 *         # real parts are equal
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":31
 *     elif cimagl(a) < cimagl(b):
 *         # real parts are equal
 *         return -1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":33
 *         return -1
 *     else:
 *         return 0             # <<<<<<<<<<<<<<
 * 
...
/* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":38
 * 
 * # EXPLICIT TYPE TESTS
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_25find_INT64_t_COMPLEX256_t_find_bisec_INT64_t_COMPLEX256_t(__pyx_t_long_double_complex __pyx_v_element, __pyx_t_long_double_complex *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":52
 * 
 *     """
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":57
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":58
 * 
 *     index = -1
 *     lb_ = lb             # <<<<<<<<<<<<<<
 *     ub_ = ub
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":59
 *     index = -1
 *     lb_ = lb
 *     ub_ = ub             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":66
 ...
 */
  while (1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":67
 *     # but to find complex numbers in an array, this works perfectly
 *     while index == -1:
 *         middle_ = <INT64_t> floor((lb_ + ub_) / 2)             # <<<<<<<<<<<<<<
 *         if compare_complex_COMPLEX256_t(array[middle_], element) > 0:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":70
 *         if compare_complex_COMPLEX256_t(array[middle_], element) > 0:
 *             ub_ = middle_
 *         elif compare_complex_COMPLEX256_t(array[middle_], element) < 0:             # <<<<<<<<<<<<<<
 *             lb_ = middle_
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":73
 *             lb_ = middle_
 *         else:
 *             index = middle_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":76
 * 
 *     # test if element found is the first one
 *     if index != -1:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":77
 *     # test if element found is the first one
 *     if index != -1:
 *         while index > lb and array[index] == element:             # <<<<<<<<<<<<<<
 *             index -= 1
 ...
 */
    while (1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":78
 *     if index != -1:
 *         while index > lb and array[index] == element:
 *             index -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":80
 *             index -= 1
 * 
 *     return index             # <<<<<<<<<<<<<<
 * 
...
/* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":82
 *     return index
 * 
 * cdef INT64_t find_linear_INT64_t_COMPLEX256_t(COMPLEX256_t element, COMPLEX256_t * array, INT64_t lb, INT64_t ub) except -1:             # <<<<<<<<<<<<<<
 *     """
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_25find_INT64_t_COMPLEX256_t_find_linear_INT64_t_COMPLEX256_t(__pyx_t_long_double_complex __pyx_v_element, __pyx_t_long_double_complex *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":99
 * 
 *     """
 *     assert lb < ub, "Lower bound must be smaller than upper bound"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_COMPLEX256_t.pyx":108
 *             break
 * 
 *     return index             # <<<<<<<<<<<<<<
 */
