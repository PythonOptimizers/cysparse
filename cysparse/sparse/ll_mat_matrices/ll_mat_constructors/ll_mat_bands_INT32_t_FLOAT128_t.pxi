...
cdef LLSparseMatrix_INT32_t_FLOAT128_t MakeBandLLSparseMatrix_INT32_t_FLOAT128_t(LLSparseMatrix_INT32_t_FLOAT128_t A, diag_coeff, list numpy_arrays):
    """
    Populate an ``LLSparseMatrix_INT32_t_FLOAT128_t with diagonals.
