...
/* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":6
...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_20sort_indices_INT64_t_sort_array_INT64_t(__pyx_t_8cysparse_12common_types_14cysparse_types_INT64_t *__pyx_v_a, __pyx_t_8cysparse_12common_types_14cysparse_types_INT64_t __pyx_v_start, __pyx_t_8cysparse_12common_types_14cysparse_types_INT64_t __pyx_v_end) {
  ...
  __pyx_t_8cysparse_12common_types_14cysparse_types_INT64_t __pyx_v_value;
  ...
  /* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":15
 ...
 */
  while (1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":19
 *     while i < end:
 * 
 *         value = a[i]             # <<<<<<<<<<<<<<
 *         j = i - 1
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":21
 *         value = a[i]
 *         j = i - 1
 *         while j >= start and a[j] > value:             # <<<<<<<<<<<<<<
 *             # shift
 ...
 */
    while (1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":23
 *         while j >= start and a[j] > value:
 *             # shift
 *             a[j+1] = a[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":28
 * 
 *         # place key at right place
 *         a[j+1] = value             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/sort_indices_INT64_t.pyx":30
 *         a[j+1] = value
 * 
 *         i += 1             # <<<<<<<<<<<<<<
 */
