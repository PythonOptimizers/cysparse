...
##################################
class CySparseCommonNumpyVectorMultiplication_LLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
##################################
class CySparseCommonNumpyVectorMultiplication_Symmetric_LLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
##################################
class CySparseCommonNumpyVectorMultiplication_WithZeroLLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Zero
##################################
class CySparseCommonNumpyVectorMultiplication_Symmetric_WithZero_LLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
# Case Non Symmetric, Non Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_LLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Non Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_Symmetric_LLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
# Case Non Symmetric, Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_WithZeroLLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_Symmetric_WithZero_LLSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
