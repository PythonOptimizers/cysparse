...
class CySparseCommonAttributesSymmetricMatrices_CSCSparseMatrix_INT32_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.A = LinearFillLLSparseMatrix(nrow=14, ncol=14, dtype=COMPLEX64_T, itype=INT32_T, store_symmetric=True)
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSCSparseMatrix_INT32_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.A = LinearFillLLSparseMatrix(nrow=14, ncol=14, dtype=COMPLEX64_T, itype=INT32_T, store_symmetric=True, store_zero=True)
