...
# Factory methods
########################################################################################################################
cdef MakeCSCSparseMatrix_INT32_t_COMPLEX256_t(INT32_t nrow,
                                        INT32_t ncol,
                                        INT32_t nnz,
                                        INT32_t * ind,
                                        INT32_t * row,
    ...
    """
    cdef CSCSparseMatrix_INT32_t_COMPLEX256_t csc_mat
    csc_mat = CSCSparseMatrix_INT32_t_COMPLEX256_t(control_object=unexposed_value,
                                             nrow=nrow,
                                             ncol=ncol,
                                             nnz=nnz,
