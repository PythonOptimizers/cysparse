...
#######################################################################
class CySparseToNDArrayNoSymmetryNoZero_CSCSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
#######################################################################
class CySparseToNDArrayWithSymmetryNoZero_CSCSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
#######################################################################
class CySparseToNDArrayNoSymmetrySWithZero_CSCSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
#######################################################################
class CySparseToNDArrayWithSymmetrySWithZero_CSCSparseMatrix_INT32_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
