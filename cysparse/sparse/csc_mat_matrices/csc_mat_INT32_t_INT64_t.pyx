...
from cysparse.sparse.sparse_utils.generic.matrix_translations_INT32_t_INT64_t cimport csr_to_csc_kernel_INT32_t_INT64_t, csc_to_csr_kernel_INT32_t_INT64_t, csc_to_ll_kernel_INT32_t_INT64_t
...
cdef class CSCSparseMatrix_INT32_t_INT64_t(ImmutableSparseMatrix_INT32_t_INT64_t):
    ...
    def to_ll(self):
        ...
        csc_to_ll_kernel_INT32_t_INT64_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT32_t *>self.ind, <INT32_t *>self.row, <INT64_t *>self.val,
                       root, col, link, val)
