...
cdef LLSparseMatrix_INT64_t_FLOAT32_t MakeBandLLSparseMatrix_INT64_t_FLOAT32_t(LLSparseMatrix_INT64_t_FLOAT32_t A, diag_coeff, list numpy_arrays):
    """
    Populate an ``LLSparseMatrix_INT64_t_FLOAT32_t with diagonals.
