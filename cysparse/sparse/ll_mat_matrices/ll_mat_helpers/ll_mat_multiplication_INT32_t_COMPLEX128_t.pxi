...
# A * b
######################
cdef cnp.ndarray[cnp.complex128_t, ndim=1, mode='c'] multiply_ll_mat_with_numpy_vector_INT32_t_COMPLEX128_t(LLSparseMatrix_INT32_t_COMPLEX128_t A, cnp.ndarray[cnp.complex128_t, ndim=1] b):
    """
...
# A^t * b
######################
cdef cnp.ndarray[cnp.complex128_t, ndim=1, mode='c'] multiply_transposed_ll_mat_with_numpy_vector_INT32_t_COMPLEX128_t(LLSparseMatrix_INT32_t_COMPLEX128_t A, cnp.ndarray[cnp.complex128_t, ndim=1] b):
    """
