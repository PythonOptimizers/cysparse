...
cdef LLSparseMatrix_INT32_t_COMPLEX256_t MakeBandLLSparseMatrix_INT32_t_COMPLEX256_t(LLSparseMatrix_INT32_t_COMPLEX256_t A, diag_coeff, list numpy_arrays):
    """
    Populate an ``LLSparseMatrix_INT32_t_COMPLEX256_t with diagonals.
