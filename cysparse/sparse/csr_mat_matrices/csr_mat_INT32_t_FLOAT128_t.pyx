...
include "csr_mat_helpers/csr_mat_is_symmetric_INT32_t_FLOAT128_t.pxi"
...
cdef class CSRSparseMatrix_INT32_t_FLOAT128_t(ImmutableSparseMatrix_INT32_t_FLOAT128_t):
    ...
    def copy(self):
        ...
        cdef CSRSparseMatrix_INT32_t_FLOAT128_t self_copy
        ...
        self_copy = CSRSparseMatrix_INT32_t_FLOAT128_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def triu(self, int k = 0):
        ...
        if self.__store_symmetric:
            ...
            csc_to_csr_kernel_INT32_t_FLOAT128_t(self.__nrow, self.__ncol, nnz,
    ...
    def matdot(self, B):
        ...
        # CASES
        if isinstance(B, CSCSparseMatrix_INT32_t_FLOAT128_t):
            return multiply_csr_mat_by_csc_mat_INT32_t_FLOAT128_t(self, B)
        else:
...
cdef MakeCSRSparseMatrix_INT32_t_FLOAT128_t(INT32_t nrow,
    ...
    """
    cdef CSRSparseMatrix_INT32_t_FLOAT128_t csr_mat

    csr_mat = CSRSparseMatrix_INT32_t_FLOAT128_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, store_symmetric=store_symmetric, store_zero=store_zero)
