...
cdef class SparseMatrix_INT64_t_COMPLEX256_t(SparseMatrix):
    ...
    def __cinit__(self, **kwargs):
        ...
        self.__index_and_type = "[INT64_t, COMPLEX256_t]"
    ...
    def H(self):
        if not self.__conjugate_transposed_proxy_matrix_generated:
            # create proxy
            self.__conjugate_transposed_proxy_matrix = ConjugateTransposedSparseMatrix_INT64_t_COMPLEX256_t(self)
    ...
    def conj(self):
        if not self.__conjugated_proxy_matrix_generated:
            # create proxy
            self.__conjugated_proxy_matrix = ConjugatedSparseMatrix_INT64_t_COMPLEX256_t(self)
