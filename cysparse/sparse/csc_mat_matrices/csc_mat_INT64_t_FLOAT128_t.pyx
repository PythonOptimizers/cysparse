...
from cysparse.sparse.sparse_utils.generic.matrix_translations_INT64_t_FLOAT128_t cimport csr_to_csc_kernel_INT64_t_FLOAT128_t, csc_to_csr_kernel_INT64_t_FLOAT128_t, csc_to_ll_kernel_INT64_t_FLOAT128_t
...
cdef class CSCSparseMatrix_INT64_t_FLOAT128_t(ImmutableSparseMatrix_INT64_t_FLOAT128_t):
    ...
    def copy(self):
        ...
        cdef CSCSparseMatrix_INT64_t_FLOAT128_t self_copy
        ...
        self_copy = CSCSparseMatrix_INT64_t_FLOAT128_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def triu(self, int k = 0):
        ...
        if self.__store_symmetric:
            ...
            csr_to_csc_kernel_INT64_t_FLOAT128_t(self.__nrow, self.__ncol, nnz,
    ...
    def to_ll(self):
        ...
        csc_to_ll_kernel_INT64_t_FLOAT128_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT64_t *>self.ind, <INT64_t *>self.row, <FLOAT128_t *>self.val,
                       root, col, link, val)
...
cdef MakeCSCSparseMatrix_INT64_t_FLOAT128_t(INT64_t nrow,
    ...
    """
    cdef CSCSparseMatrix_INT64_t_FLOAT128_t csc_mat
    csc_mat = CSCSparseMatrix_INT64_t_FLOAT128_t(control_object=unexposed_value,
                                             nrow=nrow,
                                             ncol=ncol,
                                             nnz=nnz,
