...
# matvec
############################################
class CySparseGlobalMatVecFunction_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
        ...
        # sparse vector
        self.v_ll_mat = LinearFillLLSparseMatrix(nrow=self.ncol, ncol=1, dtype=FLOAT64_T, itype=INT32_T)
...
# matvec_transp
############################################
class CySparseGlobalMatVecTranspFunction_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
        ...
        # sparse vector
        self.v_ll_mat = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=1, dtype=FLOAT64_T, itype=INT32_T)
...
# matvec_adj
############################################
class CySparseGlobalMatVecHTranspFunction_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# matvec_conj
############################################
class CySparseGlobalMatVecConjFunction_CSRSparseMatrix_INT32_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
