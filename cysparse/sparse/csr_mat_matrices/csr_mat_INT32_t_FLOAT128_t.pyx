...
cdef class CSRSparseMatrix_INT32_t_FLOAT128_t(ImmutableSparseMatrix_INT32_t_FLOAT128_t):
    ...
    def copy(self):
        ...
        self_copy = CSRSparseMatrix_INT32_t_FLOAT128_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, use_nonzero_storage=self.__use_nonzero_storage, use_symmetric_storage=self.__use_symmetric_storage)
...
cdef MakeCSRSparseMatrix_INT32_t_FLOAT128_t(INT32_t nrow,
    ...
    csr_mat = CSRSparseMatrix_INT32_t_FLOAT128_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, use_symmetric_storage=use_symmetric_storage, use_nonzero_storage=use_nonzero_storage)
