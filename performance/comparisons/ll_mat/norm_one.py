"""
This file compares different implementations of the 1-norm, i.e. :math:`||A||_1`.
...
class LLMatInfiniteNormBenchmark(benchmark.Benchmark):
    ...
    label = "1-norm with 100 elements and size = 1,000"
    each = 100
    ...
    def test_pysparse(self):
        self.p_norm_inf = self.A_p.norm('1')
        return

    def test_cysparse(self):
        self.c_norm_inf = self.A_c.norm('1')
        return
...
class LLMatInfiniteNormBenchmark_1(LLMatInfiniteNormBenchmark):
    ...
    label = "1-norm with 1,000 elements and size = 10,000"
    each = 100
...
class LLMatInfiniteNormBenchmark_2(LLMatInfiniteNormBenchmark):
    ...
    label = "1-norm with 10,000 elements and size = 100,000"
    each = 100
...
class LLMatInfiniteNormBenchmark_3(LLMatInfiniteNormBenchmark):
    ...
    label = "1-norm with 80,000 elements and size = 100,000"
    each = 100
