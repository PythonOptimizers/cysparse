...
##################################
class CySparseCommonNumpyVectorMultiplication_ConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
        ...
        self.y = np.empty(self.nrow, dtype=np.int64)
...
##################################
class CySparseCommonNumpyVectorMultiplication_Symmetric_ConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
        ...
        # numpy vectors
        self.x = np.empty(self.size, dtype=np.int64)
...
##################################
class CySparseCommonNumpyVectorMultiplication_WithZeroConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Zero
##################################
class CySparseCommonNumpyVectorMultiplication_Symmetric_WithZero_ConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10

        self.A = LinearFillLLSparseMatrix(size=self.size, dtype=INT64_T, itype=INT64_T, store_symmetry=True, store_zero=True)
...
# Case Non Symmetric, Non Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_ConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
        ...
        # numpy vectors
        self.x = np.empty(self.ncol, dtype=np.int64)
        self.x_strided = np.empty(self.ncol * self.stride_factor, dtype=np.int64)
        self.y = np.empty(self.nrow, dtype=np.int64)
        self.y_strided = np.empty(self.nrow * self.stride_factor, dtype=np.int64)
...
# Case Symmetric, Non Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_Symmetric_ConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
        ...
        # numpy vectors
        self.x = np.empty(self.size, dtype=np.int64)
        self.x_strided = np.empty(self.size * self.stride_factor, dtype=np.int64)
...
# Case Non Symmetric, Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_WithZeroConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Zero
##################################
class CySparseCommonNumpyVectorWithStrideMultiplication_Symmetric_WithZero_ConjugateTransposedSparseMatrix_INT64_t_INT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
