...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_35matrix_translations_INT32_t_INT32_t_csr_to_csc_kernel_INT32_t_INT32_t(__pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_nrow, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_ncol, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_nnz, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_ind, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_col, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_val, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_ind, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_row, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_val) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":23
 * 
 *     # initialize to 0
 *     for j from 0 <= j <= ncol:             # <<<<<<<<<<<<<<
 *         csc_ind[j] = 0
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j <= __pyx_t_1; __pyx_v_j++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":24
 *     # initialize to 0
 *     for j from 0 <= j <= ncol:
 *         csc_ind[j] = 0             # <<<<<<<<<<<<<<
 *     # count nnz per column
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":26
 *         csc_ind[j] = 0
 *     # count nnz per column
 *     for n from 0 <= n < nnz:             # <<<<<<<<<<<<<<
 *         csc_ind[csr_col[n]] += 1
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":37
 *         temp  = csc_ind[j]
 *         csc_ind[j] = cumsum
 *         cumsum += temp             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":49
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":50
 * 
 *     for i from 0 <= i < nrow:
 *         for jj from csr_ind[i] <= jj < csr_ind[i+1]:             # <<<<<<<<<<<<<<
 *             j  = csr_col[jj]
 ...
 */
    ...
    for (__pyx_v_jj = (__pyx_v_csr_ind[__pyx_v_i]); __pyx_v_jj < __pyx_t_2; __pyx_v_jj++) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":51
 *     for i from 0 <= i < nrow:
 *         for jj from csr_ind[i] <= jj < csr_ind[i+1]:
 *             j  = csr_col[jj]             # <<<<<<<<<<<<<<
 *             dest = csc_ind[j]
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":52
 *         for jj from csr_ind[i] <= jj < csr_ind[i+1]:
 *             j  = csr_col[jj]
 *             dest = csc_ind[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j <= __pyx_t_1; __pyx_v_j++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":65
 * 
 *     for j from 0 <= j <= ncol:
 *         temp   = csc_ind[j]             # <<<<<<<<<<<<<<
 *         csc_ind[j] = last
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":67
 *         temp   = csc_ind[j]
 *         csc_ind[j] = last
 *         last   = temp             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_35matrix_translations_INT32_t_INT32_t_csc_to_csr_kernel_INT32_t_INT32_t(__pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_nrow, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_ncol, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_nnz, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_ind, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_row, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_val, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_ind, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_col, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_val) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":90
 * 
 *     # initialize to 0
 *     for i from 0 <= i <= nrow:             # <<<<<<<<<<<<<<
 *         csr_ind[i] = 0
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i <= __pyx_t_1; __pyx_v_i++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":91
 *     # initialize to 0
 *     for i from 0 <= i <= nrow:
 *         csr_ind[i] = 0             # <<<<<<<<<<<<<<
 *     # count nnz per row
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":93
 *         csr_ind[i] = 0
 *     # count nnz per row
 *     for n from 0 <= n < nnz:             # <<<<<<<<<<<<<<
 *         csr_ind[csc_row[n]] += 1
 ...
 */
  ...
  for (__pyx_v_n = 0; __pyx_v_n < __pyx_t_1; __pyx_v_n++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":94
 *     # count nnz per row
 *     for n from 0 <= n < nnz:
 *         csr_ind[csc_row[n]] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_v_ii = (__pyx_v_csc_ind[__pyx_v_j]); __pyx_v_ii < __pyx_t_2; __pyx_v_ii++) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":118
 *     for j from 0 <= j < ncol:
 *         for ii from csc_ind[j] <= ii < csc_ind[j+1]:
 *             i  = csc_row[ii]             # <<<<<<<<<<<<<<
 *             dest = csr_ind[i]
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":121
 *             dest = csr_ind[i]
 * 
 *             csr_col[dest] = j             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":122
 * 
 *             csr_col[dest] = j
 *             csr_val[dest] = csc_val[ii]             # <<<<<<<<<<<<<<
 * 
