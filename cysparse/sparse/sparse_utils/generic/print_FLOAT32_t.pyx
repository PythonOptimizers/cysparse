...
cdef element_to_string_FLOAT32_t(FLOAT32_t v, int cell_width=10):
    """
    Return a string representing an element of type FLOAT32_t.
...
cdef conjugated_element_to_string_FLOAT32_t(FLOAT32_t v, int cell_width=10):
    """
    Return a string representing the conjugate of an element of type FLOAT32_t.
    ...
    return element_to_string_FLOAT32_t(v)



cdef empty_to_string_FLOAT32_t(int cell_width=10):
    """
