...
# Factory methods
########################################################################################################################
cdef MakeCSCSparseMatrix_INT32_t_INT32_t(INT32_t nrow, INT32_t ncol, INT32_t nnz, INT32_t * ind, INT32_t * row, INT32_t * val, bint __is_symmetric):
    """
    ...
    """
    csc_mat = CSCSparseMatrix_INT32_t_INT32_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, __is_symmetric=__is_symmetric)
