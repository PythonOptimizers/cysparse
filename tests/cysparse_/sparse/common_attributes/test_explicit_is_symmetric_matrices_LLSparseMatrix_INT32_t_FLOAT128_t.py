...
##################################
class CySparseExplicitIsSymmetricAttributesRestoreSymmetryMatrices_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
##################################
class CySparseExplicitIsSymmetricAttributesRestoreSymmetryWithZeroMatrices_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
##################################
class CySparseExplicitIsSymmetricAttributesDestroySymmetryMatrices_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
...
##################################
class CySparseExplicitIsSymmetricAttributesDestroySymmetryWithZeroMatrices_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 10
