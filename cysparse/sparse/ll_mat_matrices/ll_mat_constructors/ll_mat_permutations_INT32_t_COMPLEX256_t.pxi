...
cdef LLSparseMatrix_INT32_t_COMPLEX256_t MakePermutationLLSparseMatrix_INT32_t_COMPLEX256_t(LLSparseMatrix_INT32_t_COMPLEX256_t A, cnp.ndarray numpy_vector):
    """
    Populate an ``LLSparseMatrix_INT32_t_COMPLEX256_t as a permutation matrix given a vector of permutation.

    See https://en.wikipedia.org/wiki/Permutation_matrix.

    Args:
        A: A ``LLSparseMatrix_INT32_t_COMPLEX256_t`` matrix.
