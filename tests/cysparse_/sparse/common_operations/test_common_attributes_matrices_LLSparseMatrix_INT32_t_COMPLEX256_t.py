...
class CySparseCommonAttributesMatrices_LLSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
class CySparseCommonAttributesSymmetricMatrices_LLSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
...
class CySparseCommonAttributesWithZeroMatrices_LLSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_LLSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
