...
cdef LLSparseMatrix_INT32_t_FLOAT64_t MakeBandLLSparseMatrix_INT32_t_FLOAT64_t(LLSparseMatrix_INT32_t_FLOAT64_t A, diag_coeff, list numpy_arrays):
    """
    Populate an ``LLSparseMatrix_INT32_t_FLOAT64_t with diagonals.
