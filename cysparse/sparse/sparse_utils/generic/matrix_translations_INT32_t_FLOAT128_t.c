...
/* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":4
 * 
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":68
 *     cdef INT32_t last = 0
 * 
 *     for j from 0 <= j <= ncol:             # <<<<<<<<<<<<<<
 *         temp   = csc_ind[j]
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":70
 *     for j from 0 <= j <= ncol:
 *         temp   = csc_ind[j]
 *         csc_ind[j] = last             # <<<<<<<<<<<<<<
 *         last   = temp
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_1; __pyx_v_j++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":125
 * 
 *     for j from 0 <= j < ncol:
 *         for ii from csc_ind[j] <= ii < csc_ind[j+1]:             # <<<<<<<<<<<<<<
 *             i  = csc_row[ii]
 ...
 */
    ...
    for (__pyx_v_ii = (__pyx_v_csc_ind[__pyx_v_j]); __pyx_v_ii < __pyx_t_2; __pyx_v_ii++) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":126
 *     for j from 0 <= j < ncol:
 *         for ii from csc_ind[j] <= ii < csc_ind[j+1]:
 *             i  = csc_row[ii]             # <<<<<<<<<<<<<<
 *             dest = csr_ind[i]
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":139
 *     cdef INT32_t last = 0
 * 
 *     for i from 0 <= i <= nrow:             # <<<<<<<<<<<<<<
 *         temp   = csr_ind[i]
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_FLOAT128_t.pyx":141
 *     for i from 0 <= i <= nrow:
 *         temp   = csr_ind[i]
 *         csr_ind[i] = last             # <<<<<<<<<<<<<<
 *         last   = temp
