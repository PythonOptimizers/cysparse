...
###########################################
cdef void multiply_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
             COMPLEX128_t *val, INT32_t *row, INT32_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n,
            COMPLEX128_t *x, INT32_t incx,
            COMPLEX128_t *y, INT32_t incy,
            COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n,
                COMPLEX128_t *x, INT32_t incx,
                COMPLEX128_t *y, INT32_t incy,
                COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, INT32_t incx, COMPLEX128_t *y, INT32_t incy,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute :math:`y = A^t * x`.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_transposed_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_transposed_sym_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute :math:`y = A^h * x`.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, INT32_t incx, COMPLEX128_t *y, INT32_t incy,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute :math:`y = A^h * x`.
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_transposed_sym_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n,
    COMPLEX128_t *x, INT32_t incx,COMPLEX128_t *y, INT32_t incy,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute :math:`y = A^h * x`.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugated_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute ``y = conj(A) * x``.
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugated_sym_csc_mat_with_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n, COMPLEX128_t *x, COMPLEX128_t *y,
             COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute ``y = conj(A) * x``.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugated_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n,
         COMPLEX128_t *x, INT32_t incx,
         COMPLEX128_t *y, INT32_t incy,
         COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugated_sym_csc_mat_with_strided_numpy_vector_kernel_INT32_t_COMPLEX128_t(INT32_t m, INT32_t n,
            COMPLEX128_t *x, INT32_t incx, COMPLEX128_t *y, INT32_t incy,
            COMPLEX128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute ``y = conj(A) * x``.
