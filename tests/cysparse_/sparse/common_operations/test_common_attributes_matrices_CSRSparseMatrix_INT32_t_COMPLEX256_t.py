...
class CySparseCommonAttributesMatrices_CSRSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
class CySparseCommonAttributesSymmetricMatrices_CSRSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=COMPLEX256_T, itype=INT32_T, store_symmetric=True)
...
class CySparseCommonAttributesWithZeroMatrices_CSRSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSRSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=COMPLEX256_T, itype=INT32_T, store_symmetric=True, store_zero=True)
