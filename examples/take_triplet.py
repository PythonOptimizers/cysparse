...
b = np.empty((take_size,),dtype=np.float64)
l1.take_triplet([0,1,2],[2,2,2], b)
print b

c = np.empty((take_size,),dtype=np.float64)
id1 = np.array([0, 1, 2], dtype=np.int32)
id2 = np.array([2, 2 ,2], dtype=np.int32)
