...
###########################################
cdef void multiply_csc_mat_with_numpy_vector_kernel_INT64_t_FLOAT32_t(INT64_t m, INT64_t n, FLOAT32_t *x, FLOAT32_t *y,
         FLOAT32_t *val, INT64_t *row, INT64_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_numpy_vector_kernel_INT64_t_FLOAT32_t(INT64_t m, INT64_t n, FLOAT32_t *x, FLOAT32_t *y,
             FLOAT32_t *val, INT64_t *row, INT64_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_csc_mat_with_strided_numpy_vector_kernel_INT64_t_FLOAT32_t(INT64_t m, INT64_t n,
            FLOAT32_t *x, INT64_t incx,
            FLOAT32_t *y, INT64_t incy,
            FLOAT32_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_strided_numpy_vector_kernel_INT64_t_FLOAT32_t(INT64_t m, INT64_t n,
                FLOAT32_t *x, INT64_t incx,
                FLOAT32_t *y, INT64_t incy,
                FLOAT32_t *val, INT64_t *row, INT64_t *ind):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_numpy_vector_kernel_INT64_t_FLOAT32_t(INT64_t m, INT64_t n, FLOAT32_t *x, FLOAT32_t *y,
         FLOAT32_t *val, INT64_t *row, INT64_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT64_t_FLOAT32_t(INT64_t m, INT64_t n, FLOAT32_t *x, INT64_t incx, FLOAT32_t *y, INT64_t incy,
         FLOAT32_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute :math:`y = A^t * x`.
