...
class CySparseCommonAttributesSymmetricMatrices_CSRSparseMatrix_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.A = LinearFillLLSparseMatrix(nrow=14, ncol=14, dtype=FLOAT128_T, itype=INT64_T, store_symmetric=True)
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSRSparseMatrix_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.A = LinearFillLLSparseMatrix(nrow=14, ncol=14, dtype=FLOAT128_T, itype=INT64_T, store_symmetric=True, store_zero=True)
