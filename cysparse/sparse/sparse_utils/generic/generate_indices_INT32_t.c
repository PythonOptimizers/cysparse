...
/* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":63
 * 
 * 
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24generate_indices_INT32_t_create_c_array_indices_from_python_object_INT32_t(__pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_max_length, PyObject *__pyx_v_obj, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_number_of_elements) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":105
 *     ####################################################################################################################
 *     #                                            *** Integer ***
 *     if PyInt_Check(obj):             # <<<<<<<<<<<<<<
 *         i = PyInt_AS_LONG(obj)
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":108
 *         i = PyInt_AS_LONG(obj)
 *         # test if index is valid
 *         if not (0 <= i < max_length):             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_3 = 0;
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyString_Format(__pyx_kp_s_Index_d_out_of_bounds_d_d, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __Pyx_GIVEREF(__pyx_t_4);
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_IndexError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 109; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":153
 *                     raise IndexError("Index %d out of bounds [%d, %d[" % (<long>index, 0, max_length))
 *                     return NULL
 *                 indices[i] = <INT32_t> index             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":156
 *             else:
 *                 PyMem_Free(indices)
 *                 raise ValueError("List must only contain integers")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":162
 *         array_dim = <INT32_t> PyArray_NDIM(<PyArrayObject *>obj)
 *         if array_dim != 1:
 *             raise IndexError("Numpy array must have only one dimension")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":164
 *             raise IndexError("Numpy array must have only one dimension")
 * 
 *         length = <Py_ssize_t> PyArray_DIM(<PyArrayObject *>obj, 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":168
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":172
 *         # TODO: remove or control this is not DANGEROUS
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 185; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":187
 *                 raise IndexError("Index %d out of bounds [%d, %d[" % (index, 0, max_length))
 *                 return NULL
 *             indices[i] = array_data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_TypeError, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":194
 *     number_of_elements[0] = <INT32_t> length
 * 
 *     return indices             # <<<<<<<<<<<<<<
 */
 ...
 *     number_of_elements[0] = <INT32_t> length
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_Index_object_is_not_recognized_t); if (unlikely(!__pyx_tuple__4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":22
 * 
