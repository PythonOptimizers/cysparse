...
class CySparseCommonAttributesSymmetricMatrices_CSCSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=FLOAT64_T, itype=INT64_T, store_symmetric=True)
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSCSparseMatrix_INT64_t_FLOAT64_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=FLOAT64_T, itype=INT64_T, store_symmetric=True, store_zero=True)
