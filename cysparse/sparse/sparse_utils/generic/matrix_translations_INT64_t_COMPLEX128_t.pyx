...
cdef csr_to_ll_kernel_INT64_t_COMPLEX128_t(INT64_t nrow, INT64_t ncol, INT64_t nnz,
                                      INT64_t * csr_ind, INT64_t * csr_col, COMPLEX128_t * csr_val,
                                      INT64_t * ll_root, INT64_t * ll_col, INT64_t * ll_link, COMPLEX128_t * ll_val):
    """
...
cdef csc_to_ll_kernel_INT64_t_COMPLEX128_t(INT64_t nrow, INT64_t ncol, INT64_t nnz,
                                      INT64_t * csc_ind, INT64_t * csc_row, COMPLEX128_t * csc_val,
                                      INT64_t * ll_root, INT64_t * ll_col, INT64_t * ll_link, COMPLEX128_t * ll_val):
    """
    Translate an CSR to an LL matrix format.
    ...
    csc_to_csr_kernel_INT64_t_COMPLEX128_t(nrow, ncol, nnz, csc_ind, csc_row, csc_val, ind, col, val)

    ############
    # then transform CSR to LL
    ############
    csr_to_ll_kernel_INT64_t_COMPLEX128_t(nrow, ncol, nnz,
                                    ind, col, val,
