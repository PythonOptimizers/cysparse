...
cdef LLSparseMatrix_INT32_t_INT64_t MakeLLSparseMatrixFromMMFile_INT32_t_INT64_t(str mm_filename, bint use_nonzero_storage=False, bint test_bounds=True):
    cdef:
        str line
        list token_list
        str token
    ...
    with open(mm_filename, 'r') as f:
        ...
        A = LLSparseMatrix_INT32_t_INT64_t(control_object=unexposed_value,
                                          nrow=nrow,
                                          ncol=ncol,
                                          size_hint=nnz,
...
# TODO: write this!
cdef LLSparseMatrix_INT32_t_INT64_t MakeLLSparseMatrixFromMMFile2_INT32_t_INT64_t(str mm_filename, bint use_nonzero_storage=False, bint test_bounds=True):
    cdef:
        str line
        list token_list
        str token
