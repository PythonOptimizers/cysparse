...
from cysparse.sparse.ll_mat_views.ll_mat_view_INT64_t_INT64_t cimport PyLLSparseMatrixView_Check
...
include "ll_mat_helpers/ll_mat_addition_INT64_t_INT64_t.pxi"
include "ll_mat_helpers/ll_mat_is_symmetric_INT64_t_INT64_t.pxi"
...
cdef class LLSparseMatrix_INT64_t_INT64_t(MutableSparseMatrix_INT64_t_INT64_t):
    ...
    def is_symmetric(self):
        ...
        return is_symmetric_INT64_t_INT64_t(self)
    ...
    def copy(self):
        ...
        self_copy = LLSparseMatrix_INT64_t_INT64_t(control_object=unexposed_value, no_memory=True, nrow=self.__nrow, ncol=self.__ncol, size_hint=self.size_hint, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def create_transpose(self):
        ...
        cdef:
            INT64_t i, j, k
            LLSparseMatrix_INT64_t_INT64_t transpose

        if self.__store_symmetric:
            return self.copy()
        else:
            transpose = LLSparseMatrix_INT64_t_INT64_t(control_object=unexposed_value, nrow=self.__ncol, ncol=self.__nrow, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def to_csr(self):
        ...
        csr_mat = MakeCSRSparseMatrix_INT64_t_INT64_t(nrow=self.__nrow,
                                                     ncol=self.__ncol,
                                                     nnz=self.__nnz,
                                                     ind=ind, col=col,
                                                     val=val,
    ...
    def to_csc(self):
        ...
        csc_mat = MakeCSCSparseMatrix_INT64_t_INT64_t(nrow=self.__nrow,
                                                     ncol=self.__ncol,
                                                     nnz=self.__nnz,
                                                     ind=ind,
                                                     row=row,
    ...
    cdef fill_triplet(self, INT64_t * a_row, INT64_t * a_col, INT64_t * a_val):
        """
        Warning:
    ...
    def tril(self, int k = 0):
        ...
        cdef:
            INT64_t i, j, k_
            LLSparseMatrix_INT64_t_INT64_t ll_mat_tril

        ll_mat_tril = LLSparseMatrix_INT64_t_INT64_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=False)
    ...
    def triu(self, int k = 0):
        ...
        cdef:
            INT64_t i, j, k_
            LLSparseMatrix_INT64_t_INT64_t ll_mat_triu

        ll_mat_triu = LLSparseMatrix_INT64_t_INT64_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=False)
    ...
    def update_add_at(self, id1, id2, val):
        ...
        See :meth:`update_add_at_with_numpy_arrays_INT64_t_INT64_t`.
        """
        return update_add_at_with_numpy_arrays_INT64_t_INT64_t(self, id1, id2, val)
...
# Factory methods
########################################################################################################################
cdef MakeLLSparseMatrix_INT64_t_INT64_t(INT64_t nrow,
                                        INT64_t ncol,
                                        INT64_t nnz,
                                        INT64_t free,
                                        INT64_t nalloc,
    ...
    """
    cdef LLSparseMatrix_INT64_t_INT64_t ll_mat

    ll_mat = LLSparseMatrix_INT64_t_INT64_t(control_object=unexposed_value,
                                           no_memory=True,
                                           size_hint=nalloc,
                                           nrow=nrow,
                                           ncol=ncol,
