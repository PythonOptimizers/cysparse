...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_35matrix_translations_INT32_t_INT32_t_csr_to_csc_kernel_INT32_t_INT32_t(__pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_nrow, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_ncol, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_nnz, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_ind, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_col, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csr_val, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_ind, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_row, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_csc_val) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":14
 * 
 *     # initialize to 0
 *     for j from 0 <= j <= ncol:             # <<<<<<<<<<<<<<
 *         csc_ind[j] = 0
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j <= __pyx_t_1; __pyx_v_j++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":15
 *     # initialize to 0
 *     for j from 0 <= j <= ncol:
 *         csc_ind[j] = 0             # <<<<<<<<<<<<<<
 *     # count nnz per column
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":17
 *         csc_ind[j] = 0
 *     # count nnz per column
 *     for n from 0 <= n < nnz:             # <<<<<<<<<<<<<<
 *         csc_ind[csr_col[n]] += 1
 ...
 */
  ...
  for (__pyx_v_n = 0; __pyx_v_n < __pyx_t_1; __pyx_v_n++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":18
 *     # count nnz per column
 *     for n from 0 <= n < nnz:
 *         csc_ind[csr_col[n]] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":22
 *     # cumsum the nnz per column to get csc_ind
 *     cdef:
 *         INT32_t cumsum = 0             # <<<<<<<<<<<<<<
 *         INT32_t temp = 0
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":25
 *         INT32_t temp = 0
 * 
 *     for j from 0<= j < ncol:             # <<<<<<<<<<<<<<
 *         temp  = csc_ind[j]
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/matrix_translations_INT32_t_INT32_t.pyx":47
 *             csc_val[dest] = csr_val[jj]
 * 
 *             csc_ind[j] += 1             # <<<<<<<<<<<<<<
 * 
