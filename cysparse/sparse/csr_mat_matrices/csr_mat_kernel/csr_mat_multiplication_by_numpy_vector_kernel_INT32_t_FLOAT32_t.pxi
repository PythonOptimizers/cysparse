...
###########################################
cdef void multiply_csr_mat_with_numpy_vector_kernel_INT32_t_FLOAT32_t(INT32_t m, FLOAT32_t *x, FLOAT32_t *y,
...
###########################################
cdef void multiply_sym_csr_mat_with_numpy_vector_kernel_INT32_t_FLOAT32_t(INT32_t m, FLOAT32_t *x, FLOAT32_t *y,
             FLOAT32_t *val, INT32_t *col, INT32_t *ind):
    """
    Compute ``y = A * x``.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csr_mat_with_numpy_vector_kernel_INT32_t_FLOAT32_t(INT32_t m, INT32_t n, FLOAT32_t *x, FLOAT32_t *y,
         FLOAT32_t *val, INT32_t *col, INT32_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csr_mat_with_strided_numpy_vector_kernel_INT32_t_FLOAT32_t(INT32_t m, INT32_t n, FLOAT32_t *x, INT32_t incx, FLOAT32_t *y, INT32_t incy,
         FLOAT32_t *val, INT32_t *col, INT32_t *ind):
    """
    Compute :math:`y = A^t * x`.
