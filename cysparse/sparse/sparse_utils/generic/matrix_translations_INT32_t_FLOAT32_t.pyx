...
cdef csr_to_ll_kernel_INT32_t_FLOAT32_t(INT32_t nrow, INT32_t ncol, INT32_t nnz,
                                      INT32_t * csr_ind, INT32_t * csr_col, FLOAT32_t * csr_val,
...
cdef csc_to_ll_kernel_INT32_t_FLOAT32_t(INT32_t nrow, INT32_t ncol, INT32_t nnz,
    ...
    csc_to_csr_kernel_INT32_t_FLOAT32_t(nrow, ncol, nnz, csc_ind, csc_row, csc_val, ind, col, val)

    ############
    # then transform CSR to LL
    ############
    csr_to_ll_kernel_INT32_t_FLOAT32_t(nrow, ncol, nnz,
                                    ind, col, val,
