...
#endif
#include <math.h>
#define __PYX_HAVE__cysparse__sparse__sparse_utils__generic__generate_indices_INT32_t
#define __PYX_HAVE_API__cysparse__sparse__sparse_utils__generic__generate_indices_INT32_t
#include "string.h"
#include "stdio.h"
#include "pythread.h"
#include "limits.h"
...
#define __Pyx_MODULE_NAME "cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t"
int __pyx_module_is_main_cysparse__sparse__sparse_utils__generic__generate_indices_INT32_t = 0;

/* Implementation of 'cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t' */
...
/* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":64
 * 
 * 
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24generate_indices_INT32_t_create_c_array_indices_from_python_object_INT32_t(__pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_max_length, PyObject *__pyx_v_obj, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_number_of_elements) {
  ...
  __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_array_dim;
  __pyx_t_8cysparse_5types_14cysparse_types_INT32_t *__pyx_v_array_data;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("create_c_array_indices_from_python_object_INT32_t", 0);

  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":106
 *     ####################################################################################################################
 *     #                                            *** Integer ***
 *     if PyInt_Check(obj):             # <<<<<<<<<<<<<<
 *         i = PyInt_AS_LONG(obj)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":107
 *     #                                            *** Integer ***
 *     if PyInt_Check(obj):
 *         i = PyInt_AS_LONG(obj)             # <<<<<<<<<<<<<<
 *         # test if index is valid
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":109
 *         i = PyInt_AS_LONG(obj)
 *         # test if index is valid
 *         if not (0 <= i < max_length):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_1) {
      __pyx_t_1 = (__pyx_v_i < __pyx_v_max_length);
    }
    __pyx_t_2 = ((!(__pyx_t_1 != 0)) != 0);
    if (__pyx_t_2) {

      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":110
 *         # test if index is valid
 *         if not (0 <= i < max_length):
 *             raise IndexError("Index %d out of bounds [%d, %d[" % (i, 0, max_length))             # <<<<<<<<<<<<<<
 * 
 *         length = 1
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_3 = 0;
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyString_Format(__pyx_kp_s_Index_d_out_of_bounds_d_d, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __Pyx_GIVEREF(__pyx_t_4);
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_IndexError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":112
 *             raise IndexError("Index %d out of bounds [%d, %d[" % (i, 0, max_length))
 * 
 *         length = 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":113
 * 
 *         length = 1
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))             # <<<<<<<<<<<<<<
 *         if not indices:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":114
 *         length = 1
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:             # <<<<<<<<<<<<<<
 *             raise MemoryError()
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":115
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":117
 *             raise MemoryError()
 * 
 *         indices[0] = <INT32_t> i             # <<<<<<<<<<<<<<
 * 
 *     #                                            *** Slice ***
 */
    (__pyx_v_indices[0]) = ((__pyx_t_8cysparse_5types_14cysparse_types_INT32_t)__pyx_v_i);
    goto __pyx_L3;
  }

  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":120
 * 
 *     #                                            *** Slice ***
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":122
 *     elif PySlice_Check(obj):
 *         # slice
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)             # <<<<<<<<<<<<<<
 *         if ret:
 ...
 */
    __pyx_t_6 = PySlice_GetIndicesEx(((PySliceObject *)__pyx_v_obj), __pyx_v_max_length, (&__pyx_v_start), (&__pyx_v_stop), (&__pyx_v_step), (&__pyx_v_length)); if (unlikely(__pyx_t_6 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_v_ret = __pyx_t_6;

    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":123
 *         # slice
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)
 *         if ret:             # <<<<<<<<<<<<<<
 *             raise RuntimeError("Slice could not be translated")
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":124
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)
 *         if ret:
 *             raise RuntimeError("Slice could not be translated")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_RuntimeError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_Raise(__pyx_t_4, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":128
 *         #print "start, stop, step, length = (%d, %d, %d, %d)" % (start, stop, step, length)
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))             # <<<<<<<<<<<<<<
 *         if not indices:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":129
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:             # <<<<<<<<<<<<<<
 *             raise MemoryError()
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":130
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":133
 * 
 *         # populate indices
 *         i = start             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":134
 *         # populate indices
 *         i = start
 *         for j from 0 <= j < length:             # <<<<<<<<<<<<<<
 *             indices[j] = i
 ...
 */
    ...
    for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_7; __pyx_v_j++) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":135
 *         i = start
 *         for j from 0 <= j < length:
 *             indices[j] = i             # <<<<<<<<<<<<<<
 *             i += step
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":136
 *         for j from 0 <= j < length:
 *             indices[j] = i
 *             i += step             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":139
 * 
 *     #                                            *** List ***
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":140
 *     #                                            *** List ***
 *     elif PyList_Check(obj):
 *         length = PyList_Size(obj)             # <<<<<<<<<<<<<<
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":141
 *     elif PyList_Check(obj):
 *         length = PyList_Size(obj)
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))             # <<<<<<<<<<<<<<
 *         if not indices:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":142
 *         length = PyList_Size(obj)
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:             # <<<<<<<<<<<<<<
 *             raise MemoryError()
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":143
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
      PyErr_NoMemory(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }

    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":145
 *             raise MemoryError()
 * 
 *         for i from 0 <= i < length:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_7; __pyx_v_i++) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":146
 * 
 *         for i from 0 <= i < length:
 *             val = PyList_GetItem(obj, <Py_ssize_t>i)             # <<<<<<<<<<<<<<
 *             if PyInt_Check(val):
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":147
 *         for i from 0 <= i < length:
 *             val = PyList_GetItem(obj, <Py_ssize_t>i)
 *             if PyInt_Check(val):             # <<<<<<<<<<<<<<
 *                 index = PyInt_AS_LONG(val)
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":148
 *             val = PyList_GetItem(obj, <Py_ssize_t>i)
 *             if PyInt_Check(val):
 *                 index = PyInt_AS_LONG(val)             # <<<<<<<<<<<<<<
 *                 # test if index is valid
 ...
 */
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":150
 *                 index = PyInt_AS_LONG(val)
 *                 # test if index is valid
 *                 if not (0 <= index < max_length):             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_2) {
          __pyx_t_2 = (__pyx_v_index < __pyx_v_max_length);
        }
        __pyx_t_1 = ((!(__pyx_t_2 != 0)) != 0);
        if (__pyx_t_1) {

          /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":151
 *                 # test if index is valid
 *                 if not (0 <= index < max_length):
 *                     raise IndexError("Index %d out of bounds [%d, %d[" % (<long>index, 0, max_length))             # <<<<<<<<<<<<<<
 *                 indices[i] = <INT32_t> index
 *             else:
 */
          __pyx_t_4 = __Pyx_PyInt_From_long(((long)__pyx_v_index)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 151; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 151; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_5);
          ...
          __pyx_t_4 = 0;
          __pyx_t_5 = 0;
          __pyx_t_5 = __Pyx_PyString_Format(__pyx_kp_s_Index_d_out_of_bounds_d_d, __pyx_t_3); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 151; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_5);
          ...
          __Pyx_GIVEREF(__pyx_t_5);
          __pyx_t_5 = 0;
          __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_IndexError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 151; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":152
 *                 if not (0 <= index < max_length):
 *                     raise IndexError("Index %d out of bounds [%d, %d[" % (<long>index, 0, max_length))
 *                 indices[i] = <INT32_t> index             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":154
 *                 indices[i] = <INT32_t> index
 *             else:
 *                 PyMem_Free(indices)             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":155
 *             else:
 *                 PyMem_Free(indices)
 *                 raise ValueError("List must only contain integers")             # <<<<<<<<<<<<<<
 * 
 *     #                                            *** numpy array ***
 */
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_Raise(__pyx_t_5, 0, 0, 0);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":158
 * 
 *     #                                            *** numpy array ***
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":159
 *     #                                            *** numpy array ***
 *     elif PyArray_Check(obj):
 *         array_dim = <INT32_t> PyArray_NDIM(<PyArrayObject *>obj)             # <<<<<<<<<<<<<<
 *         if array_dim != 1:
 ...
 */
    __pyx_v_array_dim = ((__pyx_t_8cysparse_5types_14cysparse_types_INT32_t)PyArray_NDIM(((PyArrayObject *)__pyx_v_obj)));

    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":160
 *     elif PyArray_Check(obj):
 *         array_dim = <INT32_t> PyArray_NDIM(<PyArrayObject *>obj)
 *         if array_dim != 1:             # <<<<<<<<<<<<<<
 *             raise IndexError("Numpy array must have only one dimension")
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":161
 *         array_dim = <INT32_t> PyArray_NDIM(<PyArrayObject *>obj)
 *         if array_dim != 1:
 *             raise IndexError("Numpy array must have only one dimension")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_IndexError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_Raise(__pyx_t_5, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":163
 *             raise IndexError("Numpy array must have only one dimension")
 * 
 *         length = <Py_ssize_t> PyArray_DIM(<PyArrayObject *>obj, 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":165
 *         length = <Py_ssize_t> PyArray_DIM(<PyArrayObject *>obj, 0)
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))             # <<<<<<<<<<<<<<
 *         if not indices:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":166
 * 
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:             # <<<<<<<<<<<<<<
 *             raise MemoryError()
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":167
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":171
 *         # TODO: remove or control this is not DANGEROUS
 ...
 */
    __pyx_v_array_data = ((__pyx_t_8cysparse_5types_14cysparse_types_INT32_t *)PyArray_DATA(((PyArrayObject *)__pyx_v_obj)));

    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":181
 * 
 ...
 */
    ...
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_7; __pyx_v_i++) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":182
 *         # we cannot matrix_copy the C-array directly as we must test each element
 *         for i from 0 <= i < length:
 *             index = <INT32_t> array_data[i]             # <<<<<<<<<<<<<<
 *             if not (0 <= index < max_length):
 ...
 */
      __pyx_v_index = ((__pyx_t_8cysparse_5types_14cysparse_types_INT32_t)(__pyx_v_array_data[__pyx_v_i]));

      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":183
 *         for i from 0 <= i < length:
 *             index = <INT32_t> array_data[i]
 *             if not (0 <= index < max_length):             # <<<<<<<<<<<<<<
 *                 raise IndexError("Index %d out of bounds [%d, %d[" % (index, 0, max_length))
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":184
 *             index = <INT32_t> array_data[i]
 *             if not (0 <= index < max_length):
 *                 raise IndexError("Index %d out of bounds [%d, %d[" % (index, 0, max_length))             # <<<<<<<<<<<<<<
 *             indices[i] = array_data[i]
 * 
 */
        __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_index); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        ...
        __pyx_t_5 = 0;
        __pyx_t_3 = 0;
        __pyx_t_3 = __Pyx_PyString_Format(__pyx_kp_s_Index_d_out_of_bounds_d_d, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        ...
        __Pyx_GIVEREF(__pyx_t_3);
        __pyx_t_3 = 0;
        __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_IndexError, __pyx_t_4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":185
 *             if not (0 <= index < max_length):
 *                 raise IndexError("Index %d out of bounds [%d, %d[" % (index, 0, max_length))
 *             indices[i] = array_data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /*else*/ {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":188
 * 
 *     else:
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_TypeError, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":190
 *         raise TypeError("Index object is not recognized to create a LLSparseMatrixView")
 * 
 *     number_of_elements[0] = <INT32_t> length             # <<<<<<<<<<<<<<
 * 
 *     return indices
 */
  (__pyx_v_number_of_elements[0]) = ((__pyx_t_8cysparse_5types_14cysparse_types_INT32_t)__pyx_v_length);

  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":192
 *     number_of_elements[0] = <INT32_t> length
 * 
 *     return indices             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t.create_c_array_indices_from_python_object_INT32_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "generate_indices_INT32_t",
    __pyx_k_Some_pure_C_functions_to_deal_w, /* m_doc */
    -1, /* m_size */
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_IndexError = __Pyx_GetBuiltinName(__pyx_n_s_IndexError); if (!__pyx_builtin_IndexError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_builtin_RuntimeError = __Pyx_GetBuiltinName(__pyx_n_s_RuntimeError); if (!__pyx_builtin_RuntimeError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_builtin_ValueError = __Pyx_GetBuiltinName(__pyx_n_s_ValueError); if (!__pyx_builtin_ValueError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         #print "start, stop, step, length = (%d, %d, %d, %d)" % (start, stop, step, length)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Slice_could_not_be_translated); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     #                                            *** numpy array ***
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_List_must_only_contain_integers); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         length = <Py_ssize_t> PyArray_DIM(<PyArrayObject *>obj, 0)
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_Numpy_array_must_have_only_one_d); if (unlikely(!__pyx_tuple__3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 161; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     number_of_elements[0] = <INT32_t> length
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_Index_object_is_not_recognized_t); if (unlikely(!__pyx_tuple__4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initgenerate_indices_INT32_t(void); /*proto*/
PyMODINIT_FUNC initgenerate_indices_INT32_t(void)
#else
PyMODINIT_FUNC PyInit_generate_indices_INT32_t(void); /*proto*/
PyMODINIT_FUNC PyInit_generate_indices_INT32_t(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_generate_indices_INT32_t(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("generate_indices_INT32_t", __pyx_methods, __pyx_k_Some_pure_C_functions_to_deal_w, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cysparse__sparse__sparse_utils__generic__generate_indices_INT32_t) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t")) {
      if (unlikely(PyDict_SetItemString(modules, "cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":23
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Some pure C functions to deal with index objects.
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cysparse.sparse.sparse_utils.generic.generate_indices_INT32_t");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
