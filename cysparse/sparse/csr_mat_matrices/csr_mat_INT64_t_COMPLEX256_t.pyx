...
from cysparse.sparse.csc_mat_matrices.csc_mat_INT64_t_COMPLEX256_t cimport CSCSparseMatrix_INT64_t_COMPLEX256_t, MakeCSCSparseMatrix_INT64_t_COMPLEX256_t
...
include "csr_mat_helpers/csr_mat_is_symmetric_INT64_t_COMPLEX256_t.pxi"
...
cdef class CSRSparseMatrix_INT64_t_COMPLEX256_t(ImmutableSparseMatrix_INT64_t_COMPLEX256_t):
    ...
    def copy(self):
        ...
        cdef CSRSparseMatrix_INT64_t_COMPLEX256_t self_copy
        ...
        self_copy = CSRSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def triu(self, int k = 0):
        ...
        if self.__store_symmetric:
            ...
            csc_to_csr_kernel_INT64_t_COMPLEX256_t(self.__nrow, self.__ncol, nnz,
    ...
    def to_csc(self):
        ...
        csr_to_csc_kernel_INT64_t_COMPLEX256_t(self.__nrow, self.__ncol, self.__nnz,
    ...
    def matvec_htransp(self, b):
        ...
        return multiply_conjugate_transposed_csr_mat_with_numpy_vector_INT64_t_COMPLEX256_t(self, b)
    ...
    def matvec_conj(self, b):
        ...
        """
        assert are_mixed_types_compatible(COMPLEX256_T, b.dtype), "Multiplication only allowed with a Numpy compatible type (%s)!" % cysparse_to_numpy_type(COMPLEX256_T)
        return multiply_conjugated_csr_mat_with_numpy_vector_INT64_t_COMPLEX256_t(self, b)
...
# Factory methods
########################################################################################################################
cdef MakeCSRSparseMatrix_INT64_t_COMPLEX256_t(INT64_t nrow,
                                        INT64_t ncol,
                                        INT64_t nnz,
                                        INT64_t * ind,
                                        INT64_t * col,
    ...
    """
    cdef CSRSparseMatrix_INT64_t_COMPLEX256_t csr_mat

    csr_mat = CSRSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=nrow, ncol=ncol, nnz=nnz, store_symmetric=store_symmetric, store_zero=store_zero)
