...
#######################################################################
class CySparseInternalMemoryNoSymmetryNoZero_CSCSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseInternalMemoryWithSymmetryNoZero_CSCSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseInternalMemoryNoSymmetrySWithZero_CSCSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseInternalMemoryWithSymmetrySWithZero_CSCSparseMatrix_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
