...
cdef LLSparseMatrix_INT32_t_FLOAT128_t multiply_transposed_ll_mat_with_self(LLSparseMatrix_INT32_t_FLOAT128_t A):
    ...
    C = LLSparseMatrix_INT32_t_FLOAT128_t(control_object=unexposed_value, nrow=A.ncol, ncol=A.ncol, size_hint=size_hint, use_zero_storage=use_zero_storage, use_symmetric_storage=True)
