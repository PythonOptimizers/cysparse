...
#endif
#include <math.h>
#define __PYX_HAVE__cysparse__sparse__sparse_utils__generic__generate_indices_INT64_t
#define __PYX_HAVE_API__cysparse__sparse__sparse_utils__generic__generate_indices_INT64_t
#include "string.h"
#include "stdio.h"
#include "pythread.h"
#include "limits.h"
...
#define __Pyx_MODULE_NAME "cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t"
int __pyx_module_is_main_cysparse__sparse__sparse_utils__generic__generate_indices_INT64_t = 0;

/* Implementation of 'cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t' */
...
/* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":64
 * 
 * 
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24generate_indices_INT64_t_create_c_array_indices_from_python_object_INT64_t(__pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_max_length, PyObject *__pyx_v_obj, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t *__pyx_v_number_of_elements) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":106
 *     ####################################################################################################################
 *     #                                            *** Integer ***
 *     if PyInt_Check(obj):             # <<<<<<<<<<<<<<
 *         i = PyInt_AS_LONG(obj)
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":109
 *         i = PyInt_AS_LONG(obj)
 *         # test if index is valid
 *         if not (0 <= i < max_length):             # <<<<<<<<<<<<<<
 ...
 *         length = 1
 */
      __pyx_t_3 = __Pyx_PyInt_From_long(__pyx_v_i); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyInt_From_long(__pyx_v_max_length); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 110; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":112
 *             raise IndexError("Index %d out of bounds [%d, %d[" % (i, 0, max_length))
 * 
 *         length = 1             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":120
 * 
 *     #                                            *** Slice ***
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":122
 *     elif PySlice_Check(obj):
 *         # slice
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)             # <<<<<<<<<<<<<<
 *         if ret:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":181
 * 
 ...
 */
        ...
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_3 = __Pyx_PyInt_From_long(__pyx_v_max_length); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":190
 *         raise TypeError("Index object is not recognized to create a LLSparseMatrixView")
 * 
 *     number_of_elements[0] = <INT64_t> length             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t.create_c_array_indices_from_python_object_INT64_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_cysparse__sparse__sparse_utils__generic__generate_indices_INT64_t) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t")) {
      if (unlikely(PyDict_SetItemString(modules, "cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT64_t.pyx":23
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cysparse.sparse.sparse_utils.generic.generate_indices_INT64_t");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
