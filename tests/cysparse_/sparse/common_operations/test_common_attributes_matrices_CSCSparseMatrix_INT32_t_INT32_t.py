...
class CySparseCommonAttributesSymmetricMatrices_CSCSparseMatrix_INT32_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=INT32_T, itype=INT32_T, store_symmetric=True)
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSCSparseMatrix_INT32_t_INT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
        self.A = LinearFillLLSparseMatrix(nrow=self.nrow, ncol=self.ncol, dtype=INT32_T, itype=INT32_T, store_symmetric=True, store_zero=True)
