...
"""
This file tests the **conjugate transposed** multiplication of an :class:`CSCSparseMatrix` matrix with a :program:`NumPy` vector.
...
# Tests
########################################################################################################################
class CySparseCSCConjugateTransposedMultiplicationWithANumpyVectorBaseTestCase(unittest.TestCase):
    def setUp(self):
        pass

class CySparseCSCConjugateTransposedMultiplicationWithANumpyVectorTestCase(CySparseCSCConjugateTransposedMultiplicationWithANumpyVectorBaseTestCase):
    """
    ...
    def test_simple_multiplication_one_by_one(self):
        ...
        csc_y = self.l_1_1_csc.matvec_htransp(self.x_COMPLEX64_t)
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_1_2.matvec_htransp(self.x_COMPLEX128_t)
        csc_y = self.l_1_2_csc.matvec_htransp(self.x_COMPLEX128_t)
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_1_3.matvec_htransp(self.x_COMPLEX256_t)
        csc_y = self.l_1_3_csc.matvec_htransp(self.x_COMPLEX256_t)
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
        ...
        csc_y = self.l_2_1_csc.matvec_htransp(self.x_COMPLEX64_t)
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_2_2.matvec_htransp(self.x_COMPLEX128_t)
        csc_y = self.l_2_2_csc.matvec_htransp(self.x_COMPLEX128_t)
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_2_3.matvec_htransp(self.x_COMPLEX256_t)
        csc_y = self.l_2_3_csc.matvec_htransp(self.x_COMPLEX256_t)
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
...
class CySparseSymCSCConjugateTransposedMultiplicationWithANumpyVectorTestCase(CySparseCSCConjugateTransposedMultiplicationWithANumpyVectorBaseTestCase):
    """
...
class CySparseCSCConjugateTransposedMultiplicationWithAStridedNumpyVectorTestCase(CySparseCSCConjugateTransposedMultiplicationWithANumpyVectorBaseTestCase):
    """
    ...
    def test_simple_multiplication_one_by_one(self):
        ...
        l_y = self.l_1_1.matvec_htransp(self.x_COMPLEX64_t)
        csc_y = self.l_1_1_csc.matvec_htransp(self.x_strided_COMPLEX64_t[::self.stride_factor])
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_1_2.matvec_htransp(self.x_COMPLEX128_t)
        csc_y = self.l_1_2_csc.matvec_htransp(self.x_strided_COMPLEX128_t[::self.stride_factor])
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_1_3.matvec_htransp(self.x_COMPLEX256_t)
        csc_y = self.l_1_3_csc.matvec_htransp(self.x_strided_COMPLEX256_t[::self.stride_factor])
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
        ...
        l_y = self.l_2_1.matvec_htransp(self.x_COMPLEX64_t)
        csc_y = self.l_2_1_csc.matvec_htransp(self.x_strided_COMPLEX64_t[::self.stride_factor])
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_2_2.matvec_htransp(self.x_COMPLEX128_t)
        csc_y = self.l_2_2_csc.matvec_htransp(self.x_strided_COMPLEX128_t[::self.stride_factor])
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
  
        l_y = self.l_2_3.matvec_htransp(self.x_COMPLEX256_t)
        csc_y = self.l_2_3_csc.matvec_htransp(self.x_strided_COMPLEX256_t[::self.stride_factor])
        for i in xrange(self.ncol):
            self.failUnless(l_y[i] == csc_y[i])
...
class CySparseSymCSCConjugateTransposedMultiplicationWithAStridedNumpyVectorTestCase(CySparseCSCConjugateTransposedMultiplicationWithANumpyVectorBaseTestCase):
    """
