...
#######################################################################
class CySparsecombilisNoSymmetryNoZero_CSRSparseMatrix_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisWithSymmetryNoZero_CSRSparseMatrix_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisNoSymmetrySWithZero_CSRSparseMatrix_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisWithSymmetrySWithZero_CSRSparseMatrix_INT64_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
