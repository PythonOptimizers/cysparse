...
#######################################################################
class CySparsecombilisNoSymmetryNoZero_TransposedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisWithSymmetryNoZero_TransposedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisNoSymmetrySWithZero_TransposedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparsecombilisWithSymmetrySWithZero_TransposedSparseMatrix_INT64_t_COMPLEX64_t_TestCase(unittest.TestCase):
    def setUp(self):
