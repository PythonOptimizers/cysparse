"""
Lightweight object to view a :class:`LLSparseMatrix_INT32_t_COMPLEX128_t`.
...
cdef class LLSparseMatrixView_INT32_t_COMPLEX128_t:
    def __cinit__(self,control_object, LLSparseMatrix_INT32_t_COMPLEX128_t A, INT32_t nrow, INT32_t ncol):
        ...
        self.type_name = "LLSparseMatrixView [INT32_t, COMPLEX128_t]"
    ...
    cdef COMPLEX128_t safe_at(self, INT32_t i, INT32_t j):
        """
    ...
    def __getitem__(self, tuple key):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[1]):
            return MakeLLSparseMatrixViewFromView_INT32_t_COMPLEX128_t(self, <PyObject *>key[0], <PyObject *>key[1])
    ...
    def __setitem__(self, tuple key, value):
        ...
        if not PyInt_Check(<PyObject *>key[0]) or not PyInt_Check(<PyObject *>key[0]):
            ...
            view = MakeLLSparseMatrixViewFromView_INT32_t_COMPLEX128_t(self, <PyObject *>key[0], <PyObject *>key[1])
        ...
        self.safe_put(i, j, <COMPLEX128_t> value)
    ...
    def matrix_copy(self, compress=True):
        """
        Create a new :class:`LLSparseMatrix_INT32_t_COMPLEX128_t` from the view and return it.

        Args:
            compress: If ``True``, we use the minimum size for the matrix.

        Note:
            Because we lost sight of zero elements added in the viewed :class:`LLSparseMatrix_INT32_t_COMPLEX128_t`,
        ...
        cdef LLSparseMatrix_INT32_t_COMPLEX128_t A_copy = LLSparseMatrix_INT32_t_COMPLEX128_t(control_object=unexposed_value,
                                                                                  nrow=self.nrow,
                                                                                  ncol=self.ncol,
                                                                                  size_hint=size_hint,
                                                                                  store_zeros=False,
    ...
    def copy(self):
        """
        Create a new :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t` from this object.
        ...
        cdef LLSparseMatrixView_INT32_t_COMPLEX128_t view = LLSparseMatrixView_INT32_t_COMPLEX128_t(unexposed_value, self.A, self.nrow, self.ncol)
...
cdef LLSparseMatrixView_INT32_t_COMPLEX128_t MakeLLSparseMatrixView_INT32_t_COMPLEX128_t(LLSparseMatrix_INT32_t_COMPLEX128_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t` for a :class:`LLSparseMatrix_INT32_t_COMPLEX128_t`.
    ...
    Returns:
        A corresponding :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t`. This view can be empty with the wrong index objects.

    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrix_INT32_t_COMPLEX128_t`.
    ...
    cdef LLSparseMatrixView_INT32_t_COMPLEX128_t view = LLSparseMatrixView_INT32_t_COMPLEX128_t(unexposed_value, A, nrow, ncol)
...
cdef LLSparseMatrixView_INT32_t_COMPLEX128_t MakeLLSparseMatrixViewFromView_INT32_t_COMPLEX128_t(LLSparseMatrixView_INT32_t_COMPLEX128_t A, PyObject* obj1, PyObject* obj2):
    """
    Factory function to create a new :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t` for a :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t`.
    ...
    Args:
        A: A :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t` to be *viewed*.
        obj1: First index object.
        obj2: Second index object.
    ...
    Warning:
        Use only factory functions to create a view to a :class:`LLSparseMatrixView_INT32_t_COMPLEX128_t`.
    ...
    cdef LLSparseMatrixView_INT32_t_COMPLEX128_t view = LLSparseMatrixView_INT32_t_COMPLEX128_t(unexposed_value, A.A, nrow, ncol)
