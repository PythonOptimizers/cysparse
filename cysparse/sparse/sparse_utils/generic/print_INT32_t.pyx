...
cdef element_to_string_INT32_t(INT32_t v, int cell_width=10):
    """
    Return a string representing an element of type INT32_t.
...
cdef conjugated_element_to_string_INT32_t(INT32_t v, int cell_width=10):
    """
    Return a string representing the conjugate of an element of type INT32_t.
    ...
    return element_to_string_INT32_t(v)



cdef empty_to_string_INT32_t(int cell_width=10):
    """
