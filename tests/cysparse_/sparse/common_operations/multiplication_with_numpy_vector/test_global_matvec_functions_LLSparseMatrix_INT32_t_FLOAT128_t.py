...
# matvec
############################################
class CySparseGlobalMatVecFunction_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# matvec_transp
############################################
class CySparseGlobalMatVecTranspFunction_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# matvec_htransp
############################################
class CySparseGlobalMatVecHTranspFunction_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# matvec_conj
############################################
class CySparseGlobalMatVecConjFunction_LLSparseMatrix_INT32_t_FLOAT128_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
