...
/* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":65
 * 
 * 
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":111
 *         # test if index is valid
 *         if not (0 <= i < max_length):
 *             raise IndexError("Index %d out of bounds [%d, %d[" % (i, 0, max_length))             # <<<<<<<<<<<<<<
 * 
 *         length = 1
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":116
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":118
 *             raise MemoryError()
 * 
 *         indices[0] = <INT32_t> i             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":121
 * 
 *     #                                            *** Slice ***
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":125
 *         ret = PySlice_GetIndicesEx(<PySliceObject*>obj, max_length, &start, &stop, &step, &length)
 *         if ret:
 *             raise RuntimeError("Slice could not be translated")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":131
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":137
 *         for j from 0 <= j < length:
 *             indices[j] = i
 *             i += step             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":144
 *         indices = <INT32_t *> PyMem_Malloc(length * sizeof(INT32_t))
 *         if not indices:
 *             raise MemoryError()             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":149
 *             val = PyList_GetItem(obj, <Py_ssize_t>i)
 *             if PyInt_Check(val):
 *                 index = PyInt_AS_LONG(val)             # <<<<<<<<<<<<<<
 *                 # test if index is valid
 ...
 */
          ...
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_max_length); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 152; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_5);
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":186
 *             if not (0 <= index < max_length):
 *                 raise IndexError("Index %d out of bounds [%d, %d[" % (index, 0, max_length))
 *             indices[i] = array_data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":189
 * 
 *     else:
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":191
 *         raise TypeError("Index object is not recognized to create a LLSparseMatrixView")
 * 
 *     number_of_elements[0] = <INT32_t> length             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":193
 *     number_of_elements[0] = <INT32_t> length
 * 
 *     return indices             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /* "cysparse/sparse/sparse_utils/generic/generate_indices_INT32_t.pyx":24
 * 
