...
###########################################
cdef void multiply_ll_mat_with_numpy_vector_kernel_INT64_t_INT32_t(INT64_t m, INT32_t *x, INT32_t *y,
         INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_ll_mat_with_numpy_vector_kernel2_INT64_t_INT32_t(INT64_t m, INT32_t [::1] x, INT32_t [::1] y,
         INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_ll_mat_with_numpy_vector_kernel_INT64_t_INT32_t(INT64_t m, INT32_t *x, INT32_t *y,
             INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_ll_mat_with_strided_numpy_vector_kernel_INT64_t_INT32_t(INT64_t m,
            INT32_t *x, INT64_t incx,
            INT32_t *y, INT64_t incy,
            INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_ll_mat_with_strided_numpy_vector_kernel_INT64_t_INT32_t(INT64_t m,
                INT32_t *x, INT64_t incx,
                INT32_t *y, INT64_t incy,
                INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_ll_mat_with_numpy_vector_kernel_INT64_t_INT32_t(INT64_t m, INT64_t n, INT32_t *x, INT32_t *y,
         INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_ll_mat_with_strided_numpy_vector_kernel_INT64_t_INT32_t(INT64_t m, INT64_t n, INT32_t *x, INT64_t incx, INT32_t *y, INT64_t incy,
         INT32_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute :math:`y = A^t * x`.
