...
###########################################
cdef void multiply_ll_mat_with_numpy_vector_kernel2_INT64_t_COMPLEX128_t(INT64_t m, COMPLEX128_t [::1] x, COMPLEX128_t [::1] y,
         COMPLEX128_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = A * x``.
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX128_t(INT64_t m, COMPLEX128_t *x, COMPLEX128_t *y,
         COMPLEX128_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = conj(A) * x``.
...
# C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_sym_ll_mat_with_numpy_vector_kernel_INT64_t_COMPLEX128_t(INT64_t m, COMPLEX128_t *x, COMPLEX128_t *y,
             COMPLEX128_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
    Compute ``y = conj(A) * x``.
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_conjugate_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX128_t(INT64_t m,
            COMPLEX128_t *x, INT64_t incx,
            COMPLEX128_t *y, INT64_t incy,
            COMPLEX128_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
...
# Non C-contiguous, symmetric
###########################################
cdef void multiply_conjugate_sym_ll_mat_with_strided_numpy_vector_kernel_INT64_t_COMPLEX128_t(INT64_t m,
                COMPLEX128_t *x, INT64_t incx,
                COMPLEX128_t *y, INT64_t incy,
                COMPLEX128_t *val, INT64_t *col, INT64_t *link, INT64_t *root):
    """
