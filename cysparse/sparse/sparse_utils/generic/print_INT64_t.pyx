...
cdef element_to_string_INT64_t(INT64_t v, int cell_width=10):
    """
    Return a string representing an element of type INT64_t.
...
cdef conjugated_element_to_string_INT64_t(INT64_t v, int cell_width=10):
    """
    Return a string representing the conjugate of an element of type INT64_t.
    ...
    return element_to_string_INT64_t(v)



cdef empty_to_string_INT64_t(int cell_width=10):
    """
