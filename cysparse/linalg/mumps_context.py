...
from cysparse.linalg.mumps.mumps_INT32_t_COMPLEX64_t import MumpsContext_INT32_t_COMPLEX64_t
    
from cysparse.linalg.mumps.mumps_INT32_t_COMPLEX128_t import MumpsContext_INT32_t_COMPLEX128_t
...
def NewMumpsContext(A, verbose=False):
    ...
    if itype == INT32_T:
        ...
        if dtype == FLOAT32_T:
            ...
            return MumpsContext_INT32_t_COMPLEX64_t(A, verbose=verbose)
    
        
        elif dtype == COMPLEX128_T: 
        
            return MumpsContext_INT32_t_COMPLEX128_t(A, verbose=verbose)
