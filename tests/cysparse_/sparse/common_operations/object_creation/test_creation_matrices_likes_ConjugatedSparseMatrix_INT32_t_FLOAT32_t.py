...
##################################
class CySparseCreationMatrices_ConjugatedSparseMatrix_INT32_t_FLOAT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
##################################
class CySparseCreationSymmetricMatrices_ConjugatedSparseMatrix_INT32_t_FLOAT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 14
...
##################################
class CySparseCreationWithZeroMatrices_ConjugatedSparseMatrix_INT32_t_FLOAT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
# Case Symmetric, Zero
##################################
class CySparseCreationSymmetricWithZeroMatrices_ConjugatedSparseMatrix_INT32_t_FLOAT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.size = 14
