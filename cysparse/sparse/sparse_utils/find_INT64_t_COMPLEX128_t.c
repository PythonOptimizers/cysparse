...
#endif
#include <math.h>
#define __PYX_HAVE__cysparse__sparse__sparse_utils__find_INT64_t
#define __PYX_HAVE_API__cysparse__sparse__sparse_utils__find_INT64_t
#include "limits.h"
#include "stdint.h"
#include "math.h"
#include "complex.h"
...
static const char *__pyx_f[] = {
  "se/sparse_utils/find_INT64_t_COMPLEX128_t.pyx",
};
...
/* Module declarations from 'cysparse.sparse.sparse_utils.find_INT64_t' */
static __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_compare_complex_COMPLEX128_t(__pyx_t_double_complex, __pyx_t_double_complex); /*proto*/
#define __Pyx_MODULE_NAME "cysparse.sparse.sparse_utils.find_INT64_t"
int __pyx_module_is_main_cysparse__sparse__sparse_utils__find_INT64_t = 0;

/* Implementation of 'cysparse.sparse.sparse_utils.find_INT64_t' */
...
/* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":15
 * 
 * 
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_compare_complex_COMPLEX128_t(__pyx_t_double_complex __pyx_v_a, __pyx_t_double_complex __pyx_v_b) {
  __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("compare_complex_COMPLEX128_t", 0);

  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":22
 *     """
 * 
 *     if creal(a) > creal(b):             # <<<<<<<<<<<<<<
 *         return 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":23
 * 
 *     if creal(a) > creal(b):
 *         return 1             # <<<<<<<<<<<<<<
 *     elif creal(a) < creal(b):
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":24
 *     if creal(a) > creal(b):
 *         return 1
 *     elif creal(a) < creal(b):             # <<<<<<<<<<<<<<
 *         return -1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":25
 *         return 1
 *     elif creal(a) < creal(b):
 *         return -1             # <<<<<<<<<<<<<<
 *     elif cimag(a) > cimag(b):
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":26
 *     elif creal(a) < creal(b):
 *         return -1
 *     elif cimag(a) > cimag(b):             # <<<<<<<<<<<<<<
 *         # real parts are equal
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":28
 *     elif cimag(a) > cimag(b):
 *         # real parts are equal
 *         return 1             # <<<<<<<<<<<<<<
 *     elif cimag(a) < cimag(b):
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":29
 *         # real parts are equal
 *         return 1
 *     elif cimag(a) < cimag(b):             # <<<<<<<<<<<<<<
 *         # real parts are equal
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":31
 *     elif cimag(a) < cimag(b):
 *         # real parts are equal
 *         return -1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":33
 *         return -1
 *     else:
 *         return 0             # <<<<<<<<<<<<<<
 * 
...
/* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":38
 * 
 * # EXPLICIT TYPE TESTS
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_find_bisec_INT64_t_COMPLEX128_t(__pyx_t_double_complex __pyx_v_element, __pyx_t_double_complex *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":52
 * 
 *     """
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":57
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":58
 * 
 *     index = -1
 *     lb_ = lb             # <<<<<<<<<<<<<<
 *     ub_ = ub
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":59
 *     index = -1
 *     lb_ = lb
 *     ub_ = ub             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":66
 ...
 */
  while (1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":67
 *     # but to find complex numbers in an array, this works perfectly
 *     while index == -1:
 *         middle_ = <INT64_t> floor((lb_ + ub_) / 2)             # <<<<<<<<<<<<<<
 *         if compare_complex_COMPLEX128_t(array[middle_], element) > 0:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":68
 *     while index == -1:
 *         middle_ = <INT64_t> floor((lb_ + ub_) / 2)
 *         if compare_complex_COMPLEX128_t(array[middle_], element) > 0:             # <<<<<<<<<<<<<<
 *             ub_ = middle_
 ...
 */
    __pyx_t_1 = ((__pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_compare_complex_COMPLEX128_t((__pyx_v_array[__pyx_v_middle_]), __pyx_v_element) > 0) != 0);
    if (__pyx_t_1) {

      /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":69
 *         middle_ = <INT64_t> floor((lb_ + ub_) / 2)
 *         if compare_complex_COMPLEX128_t(array[middle_], element) > 0:
 *             ub_ = middle_             # <<<<<<<<<<<<<<
 *         elif compare_complex_COMPLEX128_t(array[middle_], element) < 0:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":70
 *         if compare_complex_COMPLEX128_t(array[middle_], element) > 0:
 *             ub_ = middle_
 *         elif compare_complex_COMPLEX128_t(array[middle_], element) < 0:             # <<<<<<<<<<<<<<
 *             lb_ = middle_
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":71
 *             ub_ = middle_
 *         elif compare_complex_COMPLEX128_t(array[middle_], element) < 0:
 *             lb_ = middle_             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":73
 *             lb_ = middle_
 *         else:
 *             index = middle_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":76
 * 
 *     # test if element found is the first one
 *     if index != -1:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":77
 *     # test if element found is the first one
 *     if index != -1:
 *         while index > lb and array[index] == element:             # <<<<<<<<<<<<<<
 *             index -= 1
 ...
 */
    while (1) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":78
 *     if index != -1:
 *         while index > lb and array[index] == element:
 *             index -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":81
 * 
 * 
 *     return index             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.find_INT64_t.find_bisec_INT64_t_COMPLEX128_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":83
 *     return index
 * 
 * cdef INT64_t find_linear_INT64_t_COMPLEX128_t(COMPLEX128_t element, COMPLEX128_t * array, INT64_t lb, INT64_t ub) except -1:             # <<<<<<<<<<<<<<
 *     """
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_find_linear_INT64_t_COMPLEX128_t(__pyx_t_double_complex __pyx_v_element, __pyx_t_double_complex *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":97
 * 
 *     """
 *     assert lb < ub, "Lower bound must be smaller than upper bound"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":102
 *         INT64_t index
 * 
 ...
 */
  ...
  for (__pyx_v_index = __pyx_v_lb; __pyx_v_index < __pyx_t_1; __pyx_v_index++) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":103
 * 
 *     for index from lb <= index < ub:
 *         if array[index] == element:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":104
 *     for index from lb <= index < ub:
 *         if array[index] == element:
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":106
 *             break
 * 
 *     return index             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.find_INT64_t.find_linear_INT64_t_COMPLEX128_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_cysparse__sparse__sparse_utils__find_INT64_t) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "cysparse.sparse.sparse_utils.find_INT64_t")) {
      if (unlikely(PyDict_SetItemString(modules, "cysparse.sparse.sparse_utils.find_INT64_t", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_COMPLEX128_t.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cysparse.sparse.sparse_utils.find_INT64_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cysparse.sparse.sparse_utils.find_INT64_t");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
