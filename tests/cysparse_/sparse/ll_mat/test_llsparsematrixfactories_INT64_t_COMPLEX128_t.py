...
#######################################################################
class CySparseLLSparseMatrixFactoriesNoSymmetryNoZero_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseLLSparseMatrixFactoriesWithSymmetryNoZero_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseLLSparseMatrixFactoriesNoSymmetrySWithZero_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
...
#######################################################################
class CySparseLLSparseMatrixFactoriesWithSymmetrySWithZero_INT64_t_COMPLEX128_t_TestCase(unittest.TestCase):
    def setUp(self):
