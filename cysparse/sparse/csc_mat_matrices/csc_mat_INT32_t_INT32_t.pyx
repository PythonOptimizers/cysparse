...
from cysparse.sparse.ll_mat_matrices.ll_mat_INT32_t_INT32_t cimport LLSparseMatrix_INT32_t_INT32_t, MakeLLSparseMatrix_INT32_t_INT32_t
...
from cysparse.sparse.sparse_utils.generic.matrix_translations_INT32_t_INT32_t cimport csr_to_csc_kernel_INT32_t_INT32_t, csc_to_csr_kernel_INT32_t_INT32_t, csc_to_ll_kernel_INT32_t_INT32_t

from cysparse.sparse.csr_mat_matrices.csr_mat_INT32_t_INT32_t cimport CSRSparseMatrix_INT32_t_INT32_t, MakeCSRSparseMatrix_INT32_t_INT32_t
...
include "csc_mat_kernel/csc_mat_multiplication_by_numpy_vector_kernel_INT32_t_INT32_t.pxi"
include "csc_mat_helpers/csc_mat_multiplication_INT32_t_INT32_t.pxi"
include "csc_mat_helpers/csc_mat_is_symmetric_INT32_t_INT32_t.pxi"
...
cdef class CSCSparseMatrix_INT32_t_INT32_t(ImmutableSparseMatrix_INT32_t_INT32_t):
    ...
    def copy(self):
        ...
        cdef CSCSparseMatrix_INT32_t_INT32_t self_copy
        ...
        self_copy = CSCSparseMatrix_INT32_t_INT32_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def tril(self, int k = 0):
        ...
        return MakeCSCSparseMatrix_INT32_t_INT32_t(self.__nrow,
                                                  self.__ncol,
                                                  nnz,
                                                  ind,
                                                  row,
    ...
    def triu(self, int k = 0):
        ...
        if self.__store_symmetric:
            ...
            csr_to_csc_kernel_INT32_t_INT32_t(self.__nrow, self.__ncol, nnz,
    ...
    def to_csr(self):
        ...
        csc_to_csr_kernel_INT32_t_INT32_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT32_t *>self.ind, <INT32_t *>self.row, <INT32_t *>self.val,
                       ind, col, val)

        return MakeCSRSparseMatrix_INT32_t_INT32_t(self.__nrow,
                                                  self.__ncol,
                                                  self.__nnz,
                                                  ind,
                                                  col,
    ...
    def to_ll(self):
        ...
        csc_to_ll_kernel_INT32_t_INT32_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT32_t *>self.ind, <INT32_t *>self.row, <INT32_t *>self.val,
                       root, col, link, val)

        return MakeLLSparseMatrix_INT32_t_INT32_t(nrow=self.__nrow,
                                                 ncol=self.__ncol,
                                                 nnz=self.__nnz,
                                                 free=free,
                                                 nalloc=nalloc,
    ...
    def matvec(self, b):
        ...
        return multiply_csc_mat_with_numpy_vector_INT32_t_INT32_t(self, b)
