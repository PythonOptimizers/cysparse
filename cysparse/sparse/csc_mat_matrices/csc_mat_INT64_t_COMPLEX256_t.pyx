...
from cysparse.sparse.sparse_utils.generic.matrix_translations_INT64_t_COMPLEX256_t cimport csr_to_csc_kernel_INT64_t_COMPLEX256_t, csc_to_csr_kernel_INT64_t_COMPLEX256_t

from cysparse.sparse.csr_mat_matrices.csr_mat_INT64_t_COMPLEX256_t cimport CSRSparseMatrix_INT64_t_COMPLEX256_t, MakeCSRSparseMatrix_INT64_t_COMPLEX256_t
...
include "csc_mat_kernel/csc_mat_multiplication_by_numpy_vector_kernel_INT64_t_COMPLEX256_t.pxi"
include "csc_mat_helpers/csc_mat_multiplication_INT64_t_COMPLEX256_t.pxi"
...
cdef class CSCSparseMatrix_INT64_t_COMPLEX256_t(ImmutableSparseMatrix_INT64_t_COMPLEX256_t):
    ...
    def copy(self):
        ...
        cdef CSCSparseMatrix_INT64_t_COMPLEX256_t self_copy
        ...
        self_copy = CSCSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, use_nonzero_storage=self.__use_nonzero_storage, use_symmetric_storage=self.__use_symmetric_storage)
    ...
    def triu(self, int k):
        ...
        if self.__use_symmetric_storage:
            ...
            csr_val = <COMPLEX256_t *> PyMem_Malloc(self.__nnz * sizeof(COMPLEX256_t))
            if not csr_val:
                PyMem_Free(ind)
                PyMem_Free(row)
                PyMem_Free(val)
            ...
            csr_to_csc_kernel_INT64_t_COMPLEX256_t(self.__nrow, self.__ncol, nnz,
    ...
    def to_csr(self):
        ...
        csc_to_csr_kernel_INT64_t_COMPLEX256_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT64_t *>self.ind, <INT64_t *>self.row, <COMPLEX256_t *>self.val,
                       ind, col, val)
    ...
    def matvec(self, b):
        ...
        Return :math:`A * b`.
        """
        return multiply_csc_mat_with_numpy_vector_INT64_t_COMPLEX256_t(self, b)

    def matvec_transp(self, b):
        """
        Return :math:`A^t * b`.
        """
        return multiply_transposed_csc_mat_with_numpy_vector_INT64_t_COMPLEX256_t(self, b)
    ...
    def matvec_htransp(self, b):
        ...
        Return :math:`A^h * b`.
        """
        return multiply_conjugate_transposed_csc_mat_with_numpy_vector_INT64_t_COMPLEX256_t(self, b)

    def matvec_conj(self, b):
        """
        Return :math:`\textrm{conj}(A) * b`.
        """
        return multiply_conjugated_csc_mat_with_numpy_vector_INT64_t_COMPLEX256_t(self, b)
...
cdef MakeCSCSparseMatrix_INT64_t_COMPLEX256_t(INT64_t nrow,
    ...
    """
    cdef CSCSparseMatrix_INT64_t_COMPLEX256_t csc_mat
    csc_mat = CSCSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value,
                                             nrow=nrow,
                                             ncol=ncol,
                                             nnz=nnz,
