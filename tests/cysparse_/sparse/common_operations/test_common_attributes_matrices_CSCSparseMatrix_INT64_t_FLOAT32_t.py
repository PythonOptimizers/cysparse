...
class CySparseCommonAttributesSymmetricMatrices_CSCSparseMatrix_INT64_t_FLOAT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.A = LinearFillLLSparseMatrix(nrow=14, ncol=14, dtype=FLOAT32_T, itype=INT64_T, store_symmetric=True)
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSCSparseMatrix_INT64_t_FLOAT32_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.A = LinearFillLLSparseMatrix(nrow=14, ncol=14, dtype=FLOAT32_T, itype=INT64_T, store_symmetric=True, store_zero=True)
