...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_7generic_16print_FLOAT128_t_element_to_string_FLOAT128_t(__pyx_t_8cysparse_5types_14cysparse_types_FLOAT128_t __pyx_v_v, struct __pyx_opt_args_8cysparse_6sparse_12sparse_utils_7generic_16print_FLOAT128_t_element_to_string_FLOAT128_t *__pyx_optional_args) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/print_FLOAT128_t.pyx":43
 * 
 * 
 *     exp = log(fabsl(v))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/print_FLOAT128_t.pyx":45
 *     exp = log(fabsl(v))
 * 
 *     if abs(exp) <= 4:             # <<<<<<<<<<<<<<
 *         if exp < 0:
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/print_FLOAT128_t.pyx":48
 *         if exp < 0:
 * 
 *             return ("%9.6f" % v).ljust(cell_width)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /*else*/ {
      ...
      /* "cysparse/sparse/sparse_utils/generic/print_FLOAT128_t.pyx":53
 *         else:
 * 
 ...
 */
  ...
  /*else*/ {
    ...
    /* "cysparse/sparse/sparse_utils/generic/print_FLOAT128_t.pyx":58
 *     else:
 * 
