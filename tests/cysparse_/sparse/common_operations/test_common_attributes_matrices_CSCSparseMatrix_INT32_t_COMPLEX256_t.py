...
class CySparseCommonAttributesMatrices_CSCSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
class CySparseCommonAttributesSymmetricMatrices_CSCSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
...
class CySparseCommonAttributesWithZeroMatrices_CSCSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 10
        self.ncol = 14
...
class CySparseCommonAttributesSymmetricWithZeroMatrices_CSCSparseMatrix_INT32_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
        self.nrow = 14
        self.ncol = 14
