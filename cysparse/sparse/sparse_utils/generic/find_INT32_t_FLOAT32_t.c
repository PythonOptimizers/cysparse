 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_FLOAT32_t.pyx":59
 * 
 * 
 *     return index             # <<<<<<<<<<<<<<
 * 
...
/* "cysparse/sparse/sparse_utils/generic/find_INT32_t_FLOAT32_t.pyx":61
 *     return index
 * 
 * cdef INT32_t find_linear_INT32_t_FLOAT32_t(FLOAT32_t element, FLOAT32_t * array, INT32_t lb, INT32_t ub) except -1:             # <<<<<<<<<<<<<<
 *     """
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_22find_INT32_t_FLOAT32_t_find_linear_INT32_t_FLOAT32_t(__pyx_t_8cysparse_5types_14cysparse_types_FLOAT32_t __pyx_v_element, __pyx_t_8cysparse_5types_14cysparse_types_FLOAT32_t *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT32_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_FLOAT32_t.pyx":78
 * 
 *     """
 *     assert lb < ub, "Lower bound must be smaller than upper bound"             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_FLOAT32_t.pyx":85
 *     for index from lb <= index < ub:
 *         if array[index] == element:
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_FLOAT32_t.pyx":87
 *             break
 * 
 *     return index             # <<<<<<<<<<<<<<
 */
