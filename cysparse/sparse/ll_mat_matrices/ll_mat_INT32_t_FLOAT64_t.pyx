...
cdef class LLSparseMatrix_INT32_t_FLOAT64_t(MutableSparseMatrix_INT32_t_FLOAT64_t):
    ...
    def __cinit__(self,  **kwargs):
        ...
        self.type_name = "LLSparseMatrix [INT32_t, FLOAT64_t]"
    ...
    def create_transpose(self):
        ...
        if self.is_symmetric:
            ...
            transposed = LLSparseMatrix_INT32_t_FLOAT64_t(control_object=unexposed_value, nrow=self.ncol, ncol=self.nrow, size_hint=self.nnz, store_zeros=self.store_zeros, is_symmetric=self.is_symmetric)
