...
cdef LLSparseMatrix_INT32_t_FLOAT32_t multiply_two_ll_mat_INT32_t_FLOAT32_t(LLSparseMatrix_INT32_t_FLOAT32_t A, LLSparseMatrix_INT32_t_FLOAT32_t B):
    ...
    C = LLSparseMatrix_INT32_t_FLOAT32_t(control_object=unexposed_value, nrow=C_nrow, ncol=C_ncol, size_hint=size_hint, use_zero_storage=use_zero_storage)
...
cdef LLSparseMatrix_INT32_t_FLOAT32_t multiply_transposed_ll_mat_with_self(LLSparseMatrix_INT32_t_FLOAT32_t A):
    ...
    C = LLSparseMatrix_INT32_t_FLOAT32_t(control_object=unexposed_value, nrow=A.ncol, ncol=A.ncol, size_hint=size_hint, use_zero_storage=use_zero_storage, use_symmetric_storage=True)
