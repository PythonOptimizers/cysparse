...
class CySparseCommonAttributesMatricesViews_TransposedSparseMatrix_INT64_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricMatricesViews_TransposedSparseMatrix_INT64_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesWithZeroMatricesViews_TransposedSparseMatrix_INT64_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
...
class CySparseCommonAttributesSymmetricWithZeroMatricesViews_TransposedSparseMatrix_INT64_t_COMPLEX256_t_TestCase(unittest.TestCase):
    def setUp(self):
