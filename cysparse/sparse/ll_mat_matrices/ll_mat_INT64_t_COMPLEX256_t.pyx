...
from cysparse.sparse.ll_mat_views.ll_mat_view_INT64_t_COMPLEX256_t cimport PyLLSparseMatrixView_Check
...
include "ll_mat_helpers/ll_mat_is_symmetric_INT64_t_COMPLEX256_t.pxi"
...
cdef class LLSparseMatrix_INT64_t_COMPLEX256_t(MutableSparseMatrix_INT64_t_COMPLEX256_t):
    ...
    def copy(self):
        ...
        self_copy = LLSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, no_memory=True, nrow=self.__nrow, ncol=self.__ncol, size_hint=self.size_hint, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def create_transpose(self):
        ...
        if self.__store_symmetric:
            ...
            transpose = LLSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__ncol, ncol=self.__nrow, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def create_conjugate_transpose(self):
        ...
        if self.__store_symmetric:
            ...
            conjugate_transpose = LLSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__ncol, ncol=self.__nrow, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    cdef assign(self, LLSparseMatrixView_INT64_t_COMPLEX256_t view, object obj):
        ...
        cdef:
            ...
            LLSparseMatrixView_INT64_t_COMPLEX256_t A_view
    ...
    def tril(self, int k = 0):
        ...
        ll_mat_tril = LLSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=False)
    ...
    def triu(self, int k = 0):
        ...
        ll_mat_triu = LLSparseMatrix_INT64_t_COMPLEX256_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, size_hint=self.__nnz, store_zero=self.__store_zero, store_symmetric=False)
