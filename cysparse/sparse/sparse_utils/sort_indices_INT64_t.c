...
#endif
#include <math.h>
#define __PYX_HAVE__cysparse__sparse__sparse_utils__sort_indices_INT64_t
#define __PYX_HAVE_API__cysparse__sparse__sparse_utils__sort_indices_INT64_t
#include "string.h"
#include "stdio.h"
#include "pythread.h"
#include "limits.h"
...
#define __Pyx_MODULE_NAME "cysparse.sparse.sparse_utils.sort_indices_INT64_t"
int __pyx_module_is_main_cysparse__sparse__sparse_utils__sort_indices_INT64_t = 0;

/* Implementation of 'cysparse.sparse.sparse_utils.sort_indices_INT64_t' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_test;

/* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":3
...
static PyObject *__pyx_f_8cysparse_6sparse_12sparse_utils_20sort_indices_INT64_t_sort_array_INT64_t(__pyx_t_8cysparse_5types_14cysparse_types_INT64_t *__pyx_v_a, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_start, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_end) {
  ...
  /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":12
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":14
 *     i = start
 * 
 *     while i < end:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  while (1) {
    ...
    /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":16
 *     while i < end:
 * 
 *         value = a[i]             # <<<<<<<<<<<<<<
 *         j = i - 1
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":17
 * 
 *         value = a[i]
 *         j = i - 1             # <<<<<<<<<<<<<<
 *         while j >= start and a[j] > value:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":18
 *         value = a[i]
 *         j = i - 1
 *         while j >= start and a[j] > value:             # <<<<<<<<<<<<<<
 *             # shift
 ...
 */
    while (1) {
      ...
      /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":20
 *         while j >= start and a[j] > value:
 *             # shift
 *             a[j+1] = a[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":22
 *             a[j+1] = a[j]
 * 
 *             j -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":25
 * 
 *         # place key at right place
 *         a[j+1] = value             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":27
 *         a[j+1] = value
 * 
 *         i += 1             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_cysparse__sparse__sparse_utils__sort_indices_INT64_t) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "cysparse.sparse.sparse_utils.sort_indices_INT64_t")) {
      if (unlikely(PyDict_SetItemString(modules, "cysparse.sparse.sparse_utils.sort_indices_INT64_t", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cysparse/sparse/sparse_utils/sort_indices_INT64_t.pyx":1
 * from cysparse.types.cysparse_types cimport *             # <<<<<<<<<<<<<<
 * 
 * cdef sort_array_INT64_t(INT64_t * a, INT64_t start, INT64_t end):
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cysparse.sparse.sparse_utils.sort_indices_INT64_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cysparse.sparse.sparse_utils.sort_indices_INT64_t");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
