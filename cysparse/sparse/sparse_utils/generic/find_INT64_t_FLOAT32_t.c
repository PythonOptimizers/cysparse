...
static const char *__pyx_f[] = {
  "parse/sparse_utils/generic/find_INT64_t_FLOAT32_t.pyx",
  "type.pxd",
  "bool.pxd",
  "complex.pxd",
};
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.generic.find_INT64_t.find_bisec_INT64_t_FLOAT32_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_12find_INT64_t_find_linear_INT64_t_FLOAT32_t(__pyx_t_8cysparse_5types_14cysparse_types_FLOAT32_t __pyx_v_element, __pyx_t_8cysparse_5types_14cysparse_types_FLOAT32_t *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_FLOAT32_t.pyx":75
 * 
 *     """
 *     assert lb < ub, "Lower bound must be smaller than upper bound"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_v_index = __pyx_v_lb; __pyx_v_index < __pyx_t_1; __pyx_v_index++) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT64_t_FLOAT32_t.pyx":81
 * 
 *     for index from lb <= index < ub:
 *         if array[index] == element:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.generic.find_INT64_t.find_linear_INT64_t_FLOAT32_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
