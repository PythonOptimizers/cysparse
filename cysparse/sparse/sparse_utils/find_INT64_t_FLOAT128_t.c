...
static const char *__pyx_f[] = {
  "arse/sparse_utils/find_INT64_t_FLOAT128_t.pyx",
  "type.pxd",
  "bool.pxd",
  "complex.pxd",
};
...
/* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":17
 * 
 * # EXPLICIT TYPE TESTS
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_find_bisec_INT64_t_FLOAT128_t(__pyx_t_8cysparse_5types_14cysparse_types_FLOAT128_t __pyx_v_element, __pyx_t_8cysparse_5types_14cysparse_types_FLOAT128_t *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":31
 * 
 *     """
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":36
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":37
 * 
 *     index = -1
 *     lb_ = lb             # <<<<<<<<<<<<<<
 *     ub_ = ub
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":38
 *     index = -1
 *     lb_ = lb
 *     ub_ = ub             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":43
 * 
 * 
 *     while index == -1:             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":44
 * 
 *     while index == -1:
 *         middle_ = <INT64_t> floor((lb_ + ub_) / 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":46
 *         middle_ = <INT64_t> floor((lb_ + ub_) / 2)
 * 
 *         if array[middle_] > element:             # <<<<<<<<<<<<<<
 *             ub_ = middle_
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":47
 * 
 *         if array[middle_] > element:
 *             ub_ = middle_             # <<<<<<<<<<<<<<
 *         elif array[middle_] < element:
 ...
 */
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":48
 *         if array[middle_] > element:
 *             ub_ = middle_
 *         elif array[middle_] < element:             # <<<<<<<<<<<<<<
 *             lb_ = middle_
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":49
 *             ub_ = middle_
 *         elif array[middle_] < element:
 *             lb_ = middle_             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":51
 *             lb_ = middle_
 *         else:
 *             index = middle_             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":54
 * 
 *     # test if element found is the first one
 *     if index != -1:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":55
 *     # test if element found is the first one
 *     if index != -1:
 *         while index > lb and array[index] == element:             # <<<<<<<<<<<<<<
 *             index -= 1
 ...
 */
    while (1) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":56
 *     if index != -1:
 *         while index > lb and array[index] == element:
 *             index -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":59
 * 
 * 
 *     return index             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.find_INT64_t.find_bisec_INT64_t_FLOAT128_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
...
/* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":61
 *     return index
 * 
 * cdef INT64_t find_linear_INT64_t_FLOAT128_t(FLOAT128_t element, FLOAT128_t * array, INT64_t lb, INT64_t ub) except -1:             # <<<<<<<<<<<<<<
 *     """
...
static __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_f_8cysparse_6sparse_12sparse_utils_12find_INT64_t_find_linear_INT64_t_FLOAT128_t(__pyx_t_8cysparse_5types_14cysparse_types_FLOAT128_t __pyx_v_element, __pyx_t_8cysparse_5types_14cysparse_types_FLOAT128_t *__pyx_v_array, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_lb, __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_ub) {
  __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_v_index;
  __pyx_t_8cysparse_5types_14cysparse_types_INT64_t __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":75
 * 
 *     """
 *     assert lb < ub, "Lower bound must be smaller than upper bound"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":80
 *         INT64_t index
 * 
 ...
 */
  ...
  for (__pyx_v_index = __pyx_v_lb; __pyx_v_index < __pyx_t_1; __pyx_v_index++) {
    ...
    /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":81
 * 
 *     for index from lb <= index < ub:
 *         if array[index] == element:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":82
 *     for index from lb <= index < ub:
 *         if array[index] == element:
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":84
 *             break
 * 
 *     return index             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("cysparse.sparse.sparse_utils.find_INT64_t.find_linear_INT64_t_FLOAT128_t", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
#endif
{
  ...
  /* "cysparse/sparse/sparse_utils/find_INT64_t_FLOAT128_t.pyx":1
