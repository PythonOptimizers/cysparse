...
from cysparse.sparse.sparse_utils.generic.matrix_translations_INT32_t_FLOAT64_t cimport csr_to_csc_kernel_INT32_t_FLOAT64_t, csc_to_csr_kernel_INT32_t_FLOAT64_t, csc_to_ll_kernel_INT32_t_FLOAT64_t
...
include "csc_mat_helpers/csc_mat_is_symmetric_INT32_t_FLOAT64_t.pxi"
...
cdef class CSCSparseMatrix_INT32_t_FLOAT64_t(ImmutableSparseMatrix_INT32_t_FLOAT64_t):
    ...
    def copy(self):
        ...
        self_copy = CSCSparseMatrix_INT32_t_FLOAT64_t(control_object=unexposed_value, nrow=self.__nrow, ncol=self.__ncol, store_zero=self.__store_zero, store_symmetric=self.__store_symmetric)
    ...
    def triu(self, int k = 0):
        ...
        if self.__store_symmetric:
            ...
            csr_to_csc_kernel_INT32_t_FLOAT64_t(self.__nrow, self.__ncol, nnz,
    ...
    def to_ll(self):
        ...
        csc_to_ll_kernel_INT32_t_FLOAT64_t(self.__nrow, self.__ncol, self.__nnz,
                       <INT32_t *>self.ind, <INT32_t *>self.row, <FLOAT64_t *>self.val,
                       root, col, link, val)
...
cdef MakeCSCSparseMatrix_INT32_t_FLOAT64_t(INT32_t nrow,
    ...
    """
    cdef CSCSparseMatrix_INT32_t_FLOAT64_t csc_mat
    csc_mat = CSCSparseMatrix_INT32_t_FLOAT64_t(control_object=unexposed_value,
                                             nrow=nrow,
                                             ncol=ncol,
                                             nnz=nnz,
