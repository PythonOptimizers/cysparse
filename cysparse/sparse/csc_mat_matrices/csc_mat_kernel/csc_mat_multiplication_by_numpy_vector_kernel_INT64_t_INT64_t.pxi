...
cdef void multiply_csc_mat_with_numpy_vector_kernel_INT64_t_INT64_t(INT64_t m, INT64_t n, INT64_t *x, INT64_t *y,
         INT64_t *val, INT64_t *row, INT64_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_numpy_vector_kernel_INT64_t_INT64_t(INT64_t m, INT64_t n, INT64_t *x, INT64_t *y,
             INT64_t *val, INT64_t *row, INT64_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_csc_mat_with_strided_numpy_vector_kernel_INT64_t_INT64_t(INT64_t m, INT64_t n,
...
###########################################
cdef void multiply_sym_csc_mat_with_strided_numpy_vector_kernel_INT64_t_INT64_t(INT64_t m, INT64_t n,
                INT64_t *x, INT64_t incx,
                INT64_t *y, INT64_t incy,
                INT64_t *val, INT64_t *row, INT64_t *ind):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_numpy_vector_kernel_INT64_t_INT64_t(INT64_t m, INT64_t n, INT64_t *x, INT64_t *y,
         INT64_t *val, INT64_t *row, INT64_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT64_t_INT64_t(INT64_t m, INT64_t n, INT64_t *x, INT64_t incx, INT64_t *y, INT64_t incy,
         INT64_t *val, INT64_t *row, INT64_t *ind):
    """
    Compute :math:`y = A^t * x`.
