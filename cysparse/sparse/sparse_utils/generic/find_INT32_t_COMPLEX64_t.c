...
static __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24find_INT32_t_COMPLEX64_t_compare_complex_COMPLEX64_t(__pyx_t_float_complex, __pyx_t_float_complex); /*proto*/
...
/* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":18
 * 
 * 
...
static __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24find_INT32_t_COMPLEX64_t_compare_complex_COMPLEX64_t(__pyx_t_float_complex __pyx_v_a, __pyx_t_float_complex __pyx_v_b) {
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":27
 *     if crealf(a) > crealf(b):
 *         return 1
 *     elif crealf(a) < crealf(b):             # <<<<<<<<<<<<<<
 *         return -1
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":32
 *         # real parts are equal
 *         return 1
 *     elif cimagf(a) < cimagf(b):             # <<<<<<<<<<<<<<
 *         # real parts are equal
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":34
 *     elif cimagf(a) < cimagf(b):
 *         # real parts are equal
 *         return -1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":36
 *         return -1
 *     else:
 *         return 0             # <<<<<<<<<<<<<<
 * 
...
/* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":41
 * 
 * # EXPLICIT TYPE TESTS
...
static __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24find_INT32_t_COMPLEX64_t_find_bisec_INT32_t_COMPLEX64_t(__pyx_t_float_complex __pyx_v_element, __pyx_t_float_complex *__pyx_v_array, __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_lb, __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":55
 * 
 *     """
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":60
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":61
 * 
 *     index = -1
 *     lb_ = lb             # <<<<<<<<<<<<<<
 *     ub_ = ub
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":62
 *     index = -1
 *     lb_ = lb
 *     ub_ = ub             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":72
 *         middle_ = <INT32_t> floor((lb_ + ub_) / 2)
 *         if compare_complex_COMPLEX64_t(array[middle_], element) > 0:
 *             ub_ = middle_             # <<<<<<<<<<<<<<
 *         elif compare_complex_COMPLEX64_t(array[middle_], element) < 0:
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":74
 *             ub_ = middle_
 *         elif compare_complex_COMPLEX64_t(array[middle_], element) < 0:
 *             lb_ = middle_             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":79
 * 
 *     # test if element found is the first one
 *     if index != -1:             # <<<<<<<<<<<<<<
 ...
 */
    while (1) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":81
 *     if index != -1:
 *         while index > lb and array[index] == element:
 *             index -= 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":83
 *             index -= 1
 * 
 *     return index             # <<<<<<<<<<<<<<
 * 
...
/* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":85
 *     return index
 * 
 * cdef INT32_t find_linear_INT32_t_COMPLEX64_t(COMPLEX64_t element, COMPLEX64_t * array, INT32_t lb, INT32_t ub) except -1:             # <<<<<<<<<<<<<<
 *     """
...
static __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_f_8cysparse_6sparse_12sparse_utils_7generic_24find_INT32_t_COMPLEX64_t_find_linear_INT32_t_COMPLEX64_t(__pyx_t_float_complex __pyx_v_element, __pyx_t_float_complex *__pyx_v_array, __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_lb, __pyx_t_8cysparse_12common_types_14cysparse_types_INT32_t __pyx_v_ub) {
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":102
 * 
 *     """
 *     assert lb < ub, "Lower bound must be smaller than upper bound"             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":107
 *         INT32_t index
 * 
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":109
 *     for index from lb <= index < ub:
 *         if array[index] == element:
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/sparse/sparse_utils/generic/find_INT32_t_COMPLEX64_t.pyx":111
 *             break
 * 
 *     return index             # <<<<<<<<<<<<<<
 */
