...
cdef class LLSparseMatrixView_INT64_t_INT64_t:
    def __cinit__(self,control_object, LLSparseMatrix_INT64_t_INT64_t A, INT64_t nrow, INT64_t ncol):
        ...
        self.type_name = "LLSparseMatrixView [INT64_t, INT64_t]"
    ...
    def copy(self):
        ...
        cdef LLSparseMatrixView_INT64_t_INT64_t view = LLSparseMatrixView_INT64_t_INT64_t(unexposed_value, self.A, self.nrow, self.ncol)
