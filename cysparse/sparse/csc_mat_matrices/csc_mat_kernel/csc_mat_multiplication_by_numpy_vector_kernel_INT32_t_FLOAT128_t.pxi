...
###########################################
cdef void multiply_csc_mat_with_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n, FLOAT128_t *x, FLOAT128_t *y,
         FLOAT128_t *val, INT32_t *row, INT32_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n, FLOAT128_t *x, FLOAT128_t *y,
             FLOAT128_t *val, INT32_t *row, INT32_t *ind, bint init_y = 1):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_csc_mat_with_strided_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n,
            FLOAT128_t *x, INT32_t incx,
            FLOAT128_t *y, INT32_t incy,
            FLOAT128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute ``y = A * x``.
...
###########################################
cdef void multiply_sym_csc_mat_with_strided_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n,
                FLOAT128_t *x, INT32_t incx,
                FLOAT128_t *y, INT32_t incy,
                FLOAT128_t *val, INT32_t *row, INT32_t *ind):
    """
...
# C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n, FLOAT128_t *x, FLOAT128_t *y,
         FLOAT128_t *val, INT32_t *row, INT32_t *ind):
    """
...
# Non C-contiguous, non symmetric
###########################################
cdef void multiply_tranposed_csc_mat_with_strided_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n, FLOAT128_t *x, INT32_t incx, FLOAT128_t *y, INT32_t incy,
         FLOAT128_t *val, INT32_t *row, INT32_t *ind):
    """
    Compute :math:`y = A^t * x`.
