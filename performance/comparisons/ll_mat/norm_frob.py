"""
This file compares different implementations of the Frobenius norm.
...
class LLMatFrobeniusNormBenchmark(benchmark.Benchmark):
    ...
    label = "Frobenius norm with 100 elements and size = 1,000"
    each = 100
...
class LLMatFrobeniusNormBenchmark_1(LLMatFrobeniusNormBenchmark):
    ...
    label = "Frobenius norm with 1,000 elements and size = 10,000"
    each = 100
...
class LLMatFrobeniusNormBenchmark_2(LLMatFrobeniusNormBenchmark):
    ...
    label = "Frobenius norm with 10,000 elements and size = 100,000"
    each = 100
...
class LLMatFrobeniusNormBenchmark_3(LLMatFrobeniusNormBenchmark):
    ...
    label = "Frobenius norm with 80,000 elements and size = 100,000"
    each = 100
