...
###########################################
cdef void multiply_tranposed_ll_mat_with_with_strided_numpy_vector_kernel_INT32_t_FLOAT128_t(INT32_t m, INT32_t n, FLOAT128_t *x, INT32_t incx, FLOAT128_t *y, INT32_t incy,
         FLOAT128_t *val, INT32_t *col, INT32_t *link, INT32_t *root):
    """
    Compute :math:`y = A^t * x`.
