...
/* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pxd":150
 * 
 * 
...
/* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pyx":154
 *     # INIT
 *     ####################################################################################################################
...
static int __pyx_pw_8cysparse_6linalg_11suitesparse_4spqr_22spqr_INT32_t_FLOAT64_t_29SPQRContext_INT32_t_FLOAT64_t_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    if (values[1]) {
      __pyx_v_verbose = __Pyx_PyObject_IsTrue(values[1]); if (unlikely((__pyx_v_verbose == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
  ...
  /* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pyx":158
 *         """
 *         self.A = A
 *         Py_INCREF(self.A)  # increase ref to object to avoid the user deleting it explicitly or implicitly             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pyx":160
 *         Py_INCREF(self.A)  # increase ref to object to avoid the user deleting it explicitly or implicitly
 * 
 *         self.nrow = A.nrow             # <<<<<<<<<<<<<<
 *         self.ncol = A.ncol
 ...
 *         # CHOLMOD
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self->A), __pyx_n_s_to_csc); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_8cysparse_6sparse_16csc_mat_matrices_25csc_mat_INT32_t_FLOAT64_t_CSCSparseMatrix_INT32_t_FLOAT64_t))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  /* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pyx":173
 *         self.sparse_struct = cholmod_sparse()
 *         # common attributes for real and complex matrices
 *         populate1_cholmod_sparse_struct_with_CSCSparseMatrix(&self.sparse_struct, self.csc_mat)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pyx":175
 *         populate1_cholmod_sparse_struct_with_CSCSparseMatrix(&self.sparse_struct, self.csc_mat)
 * 
 *         populate2_cholmod_sparse_struct_with_CSCSparseMatrix(&self.sparse_struct, self.csc_mat)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cysparse/linalg/suitesparse/spqr/spqr_INT32_t_FLOAT64_t.pyx":193
 *         cholmod_finish(&self.common_struct)
 * 
 *         Py_DECREF(self.A) # release ref             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_8cysparse_6linalg_11suitesparse_4spqr_22spqr_INT32_t_FLOAT64_t_SPQRContext_INT32_t_FLOAT64_t) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_8cysparse_6linalg_11suitesparse_4spqr_22spqr_INT32_t_FLOAT64_t_SPQRContext_INT32_t_FLOAT64_t.tp_print = 0;
  if (PyObject_SetAttrString(__pyx_m, "SPQRContext_INT32_t_FLOAT64_t", (PyObject *)&__pyx_type_8cysparse_6linalg_11suitesparse_4spqr_22spqr_INT32_t_FLOAT64_t_SPQRContext_INT32_t_FLOAT64_t) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
